...
$(document).off('change',tabPUBLISHEDRATE+' .fixedrateflag').on('change',tabPUBLISHEDRATE+' .fixedrateflag',function(){
		var modal = '#'+$(this).closest('.modal').attr('id');
		var type = $(modal+' .type').val();
		var fixedrateflag = $(this).prop('checked');
		showHidePublishedRateFields(modal,type,fixedrateflag);

});

/*$(document).off('change',tabPUBLISHEDRATE+' .pulloutflag').on('change',tabPUBLISHEDRATE+' .pulloutflag',function(){
		var modal = '#'+$(this).closest('.modal').attr('id');
...
$(document).off('click','.editpublishedratebtn').on('click','.editpublishedratebtn',function(){
	var modal = "#editpublishedratemodal";
	var rowid = $(this).attr('rowid')
	$(modal+' .publishedratemodalid').val(rowid);

	$.post(server+'published-rate.php',{PublishedRateGetInfo:'kjoI$H2oiaah3h0$09jDppo92po@k@',id:rowid},function(data){
...
/***************************** SAVE | EDIT **************************************************/
$(document).off('click','.publishedratemodal-savebtn:not(".disabled")').on('click','.publishedratemodal-savebtn:not(".disabled")',function(){
	var modal = '#'+$(this).closest('.modal').attr('id'),
		tpl = $(modal+' .3pl').val(),
	...
	if(modal=='#editpublishedratemodal'){
		id = $(modal+' .publishedratemodalid').val();
		source = 'edit';
		newsort = 'updated_date';
	}

	
	if(tpl==''||tpl==null||tpl=='NULL'||tpl=='null'){
...
function showHidePublishedRateFields(modal,type,fixedrateflag){
	if(type=='PARCEL'){
...
$(document).off('change',tabPUBLISHEDRATE+' .type').on('change',tabPUBLISHEDRATE+' .type',function(){
...
$(document).off('click',tabPUBLISHEDRATE+' .viewpublishedratefreightchargebtn, '+tabPUBLISHEDRATE+' .viewpblfreightratebtn').on('click',tabPUBLISHEDRATE+' .viewpublishedratefreightchargebtn, '+tabPUBLISHEDRATE+' .viewpblfreightratebtn',function(){
	var modal = '#viewpublishedratefreightcharge';
	var publishedrateid = $(this).attr('rowid');
	$(modal+' #viewpublishedratefreightcharge-publishedrateid').val(publishedrateid);

	$(tabPUBLISHEDRATE+" #viewpublishedratefreightcharge-tbl").flexOptions({
...
$(document).off('click',tabPUBLISHEDRATE+' .viewpublishedratefreightcharge-insertratebtn:not(".disabled")').on('click',tabPUBLISHEDRATE+' .viewpublishedratefreightcharge-insertratebtn:not(".disabled")',function(){
		...
		var fromkg = $(modal+' .viewpublishedratefreightcharge-fromkg').val();
		var tokg = $(modal+' .viewpublishedratefreightcharge-tokg').val();
		var freightcharge = $(modal+' .viewpublishedratefreightcharge-freightcharge').val();
		var excessweightcharge = $(modal+' .viewpublishedratefreightcharge-excessweightcharge').val();

		var publishedrateid = $(modal+' #viewpublishedratefreightcharge-publishedrateid').val();




		if(fromkg==undefined||fromkg==null||fromkg==''||fromkg<0){
			$(modal+' .viewpublishedratefreightcharge-fromkg').focus();
			...
			$(modal+' .viewpublishedratefreightcharge-tokg').focus();
			...
			$(modal+' .viewpublishedratefreightcharge-freightcharge').focus();
			...
			$(modal+' .viewpublishedratefreightcharge-excessweightcharge').focus();
			...
			$('#loading-img').removeClass('hidden');
			$.post(server+'published-rate.php',{AddEditPublishedRateFreightCharge:'j$isnDPo#P3sll3p23a3!@3kzlsO!mslo#k@',publishedrateid:publishedrateid,fromkg:fromkg,tokg:tokg,freightcharge:freightcharge,excessweightcharge:excessweightcharge,source:'add'},function(data){
					if(data.trim()=='success'){
						//$(modal).modal('hide');
						//$(modal).on('hidden.bs.modal',function(){
						...
						$('#loading-img').addClass('hidden');
						$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Unable to add/edit published rate freight charge. No user permission.</div></div>");
						button.removeAttr('disabled').removeClass('disabled');
					}
					else{
						$('#loading-img').addClass('hidden');
...
$(document).off('click',tabPUBLISHEDRATE+' .editpublishedratefreightchargebtn').on('click',tabPUBLISHEDRATE+' .editpublishedratefreightchargebtn',function(){

	var modal = '#editpublishedratefreightchargemodal';
	...
	$(modal+' #publishedratefreightchargeID').val(freightchargeID);
	$(modal+' .editpublishedratefreightchargemodal-fromkg').val(fromkg);
	$(modal+' .editpublishedratefreightchargemodal-tokg').val(tokg);
	$(modal+' .editpublishedratefreightchargemodal-freightcharge').val(freightcharge);
	$(modal+' .editpublishedratefreightchargemodal-excessweightcharge').val(excessweightcharge);
	$(tabPUBLISHEDRATE+' '+modal).modal('show');


});

$(document).off('click',tabPUBLISHEDRATE+' .editpublishedratefreightchargemodal-savebtn:not("disabled")').on('click',tabPUBLISHEDRATE+' .editpublishedratefreightchargemodal-savebtn:not("disabled")',function(){
	var button = $(this);
		button.addClass("disabled");

	var publishedrateid = $('#viewpublishedratefreightcharge #viewpublishedratefreightcharge-publishedrateid').val();
	
	var modal = '#'+$(this).closest(".modal").attr('id');
	var freightchargeID = $(modal+' #publishedratefreightchargeID').val();
	var fromkg = $(modal+' .editpublishedratefreightchargemodal-fromkg').val();
	var tokg = $(modal+' .editpublishedratefreightchargemodal-tokg').val();
	var freightcharge = $(modal+' .editpublishedratefreightchargemodal-freightcharge').val();
	var excessweightcharge = $(modal+' .editpublishedratefreightchargemodal-excessweightcharge').val();


	if(fromkg==undefined||fromkg==null||fromkg==''||fromkg<0){
		$(modal+' .editpublishedratefreightchargemodal-fromkg').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide from (kg).</div></div>");
		button.removeClass('disabled');
	}
	else if(tokg==undefined||tokg==null||tokg==''||tokg<=0){
		$(modal+' .editpublishedratefreightchargemodal-tokg').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide to (kg).</div></div>");
		button.removeClass('disabled');
	}
	else if(freightcharge==undefined||freightcharge==null||freightcharge==''||freightcharge<=0){
		$(modal+' .editpublishedratefreightchargemodal-freightcharge').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide freight charge.</div></div>");
		button.removeClass('disabled');
	}
	else if(excessweightcharge==undefined||excessweightcharge==null||excessweightcharge==''||excessweightcharge<0){
		$(modal+' .editpublishedratefreightchargemodal-excessweightcharge').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide excess weight charge.</div></div>");
		button.removeClass('disabled');
	}
	else{
		$('#loading-img').removeClass('hidden');
		$.post(server+'published-rate.php',{AddEditPublishedRateFreightCharge:'j$isnDPo#P3sll3p23a3!@3kzlsO!mslo#k@',publishedrateid:publishedrateid,freightchargeID:freightchargeID,fromkg:fromkg,tokg:tokg,freightcharge:freightcharge,excessweightcharge:excessweightcharge,source:'edit'},function(data){
				if(data.trim()=='success'){
					$(modal).modal('hide');
					$(modal).on('hidden.bs.modal',function(){
...
$(document).off('click',tabPUBLISHEDRATE+' .viewpublishedratefreightcharge-clearratefieldsbtn').on('click',tabPUBLISHEDRATE+' .viewpublishedratefreightcharge-clearratefieldsbtn',function(){
		var modal = '#'+$(this).closest('.modal').attr('id');
		$(modal+' .viewpublishedratefreightcharge-fromkg').val('');
		$(modal+' .viewpublishedratefreightcharge-tokg').val('');
		$(modal+' .viewpublishedratefreightcharge-freightcharge').val('');
		$(modal+' .viewpublishedratefreightcharge-excessweightcharge').val('');
		$(modal+' .viewpublishedratefreightcharge-fromkg').focus();
});
...
$(document).off('click',tabPUBLISHEDRATE+' #uploadpublishedratemodal-uploadbtn:not(".disabled")').on('click',tabPUBLISHEDRATE+' #uploadpublishedratemodal-uploadbtn:not(".disabled")',function(){

	var modal = '#uploadpublishedratemodal';
	var modal2 = '#publishedrate-uploadtransactionlogmodal';
	var form = '#uploadpublishedratemodal-form';
	var logframe = '#publishedrateuploadtransactionlogframe';
	var button = $(this);
	button.addClass('disabled');

	if($(tabPUBLISHEDRATE+' '+modal+' .uploadpublishedratemodal-file').val().trim()==''){
		...
		$(modal).modal('hide');
		$(document).off('hidden.bs.modal',tabPUBLISHEDRATE+' '+modal).on('hidden.bs.modal',tabPUBLISHEDRATE+' '+modal,function(){
			
			$(document).off('hidden.bs.modal',tabPUBLISHEDRATE+' '+modal);
			$(tabPUBLISHEDRATE+' '+modal2).modal('show');
			$(form).submit();

...
$(document)
	.off('click', bookingreportpane + ' #bookingsummary-trans-downloadbtn:not(".disabled")')
	.on('click', bookingreportpane + ' #bookingsummary-trans-downloadbtn:not(".disabled")', function () {
		var bookingtype = $(bookingreportpane + ' .bookingsummary-bookingtype').val(),
			status = $(bookingreportpane + ' .bookingsummary-status').val(),
			...
			createddatefrom = $(bookingreportpane + ' .bookingsummary-createddatefrom').val(),
			createddateto = $(bookingreportpane + ' .bookingsummary-createddateto').val(),
		...
		var w = window.open(
			'printouts/excel/reports.booking-summary.php?status=' +
				status +
				'&origin=' +
				origin +
				'&destination=' +

...
$(document).off('click',contentWB+' #waybill-trans-newbtn:not(".disabled")').on('click',contentWB+' #waybill-trans-newbtn:not(".disabled")',function(){
	...
	$(contentWB+' .statusdiv').html('DISPATCHED');	
	
	$(contentWB+' .waybill-onholdcheckbox, '+contentWB+' .waybill-zeroratedcheckbox').prop('checked',false);
...
$(document).off('keyup',contentWB+' .waybill-vwcbm').on('keyup',contentWB+' .waybill-vwcbm',function(){
	computeRatesWB();
});
...
$(document).off('click',contentWB+' #waybillprintingmodal-savebtn:not(".disabled")').on('click',contentWB+' #waybillprintingmodal-savebtn:not(".disabled")',function(){
	...
	else */if(formtype!='EXTERNAL'&&formtype!='INTERNAL'&&formtype!='DR'){
		btn.removeClass('disabled');
			...
			if(formtype=='INTERNAL'){
									...
									if(data.trim()=='success'){
										...
										$(document).off('hidden.bs.modal',modal).on('hidden.bs.modal',modal,function(){
											...
											if($(".content>.content-tab-pane .content-tabs").find("li[data-pane='#"+tabid+"tabpane']").length>=1){
												...
												$('.content>.content-tab-pane .content-pane-wrapper>.content-pane:last-child').load("Printouts/print-preview.php?source=printouts/transactions/waybill.php?txnnumber="+waybillnumber+'tpicorpaabbccreference='+waybillnumber+"tpicorpaabbccbolnumber="+bolnumber);
												setTimeout(function(){
													$('#loading-img').addClass('hidden');
												},400);
											}
				...
				$(document).off('hidden.bs.modal',modal).on('hidden.bs.modal',modal,function(){
						...
						if($(".content>.content-tab-pane .content-tabs").find("li[data-pane='#"+tabid+"tabpane']").length>=1){
							...
							$('.content>.content-tab-pane .content-tabs').append("<li data-pane='#"+tabid+"tabpane' class='active'>"+title+"<i class='fa fa-remove'></i></li>");
							$('.content>.content-tab-pane .content-pane-wrapper').append("<div class='content-pane active' id='"+tabid+"tabpane'></div>");
							$('.content>.content-tab-pane .content-pane-wrapper>.content-pane:last-child').load("Printouts/print-preview.php?source=printouts/transactions/waybill-external-form.php?txnnumber="+waybillnumber+'tpicorpaabbccreference='+waybillnumber+'tpicorpaabbccbolnumber='+bolnumber);
							setTimeout(function(){
								$('#loading-img').addClass('hidden');
							},400);
						}
				...
				$(document).off('hidden.bs.modal',modal).on('hidden.bs.modal',modal,function(){
						...
						if($(".content>.content-tab-pane .content-tabs").find("li[data-pane='#"+tabid+"tabpane']").length>=1){
							...
							$('.content>.content-tab-pane .content-tabs').append("<li data-pane='#"+tabid+"tabpane' class='active'>"+title+"<i class='fa fa-remove'></i></li>");
							$('.content>.content-tab-pane .content-pane-wrapper').append("<div class='content-pane active' id='"+tabid+"tabpane'></div>");
							$('.content>.content-tab-pane .content-pane-wrapper>.content-pane:last-child').load("Printouts/print-preview.php?source=printouts/transactions/waybill-dr-form.php?txnnumber="+waybillnumber+'tpicorpaabbccreference='+waybillnumber+'tpicorpaabbccbolnumber='+bolnumber);
							setTimeout(function(){
								$('#loading-img').addClass('hidden');
							},400);
						}
...
$(document).off('click',contentWB+' #waybill-updatestatusmodal-savebtn:not(".disabled")').on('click',contentWB+' #waybill-updatestatusmodal-savebtn:not(".disabled")',function(){
	...
	if(status==''||status==null||status=='null'||status=='NULL'||status==undefined){
		...
		$.confirm({
				...
				confirm: function(){
					$('#loading-img').removeClass('hidden');
					$.post(server+'waybill.php',{updateStatusWaybill:'kkjO#@siaah3h0$09odfj$owenxezpo92po@k@',waybillid:waybillid,status:status,remarks:remarks,receivedby:receivedby,receiveddate:receiveddate},function(data){
...
$(document).off('change',contentWB+' .waybill-updatestatusmodal-status').on('change',contentWB+' .waybill-updatestatusmodal-status',function(){
	...
	if(status=='DEL'||status=='DELIVERED'||status=='del'||status=='delivered'||status=='RTS'||status=='RETURN TO SHIPPER'||status=='rts'||status=='return to shipper'){
			$(modal+' .receivedbywrapper, '+modal+' .receiveddatewrapper').removeClass('hidden');
	}
	else{
		$(modal+' .receivedbywrapper, '+modal+' .receiveddatewrapper').addClass('hidden');
	}

...
$(document).off('click',contentBKA+' .viewbookinghistorybtn').on('click',contentBKA+' .viewbookinghistorybtn',function(){
...
$(document).off('click',contentBKA+' .reviewbookingbtn').on('click',contentBKA+' .reviewbookingbtn',function(){
	var bookingnumber = $(this).attr('bookingnumber');
	var id = $(this).attr('rowid');
...
$(document).off('click',contentBKA+' .reviewbookingmodal-approverejectbtn').on('click',contentBKA+' .reviewbookingmodal-approverejectbtn',function(){
...
$(document).off('shown.bs.modal',contentBKA+' #bookingapproval-confirmationmodal').on('shown.bs.modal',contentBKA+' #bookingapproval-confirmationmodal',function(){
...
$(document).off('click',contentBKA+' #bookingapproval-confirmationmodal-confirmbtn:not(".disabled")').on('click',contentBKA+' #bookingapproval-confirmationmodal-confirmbtn:not(".disabled")',function(){
			...
			$.post(server+'booking-approval.php',{approveRejectBooking:'j$isnDPo#P3sll3p23a3!@3kzlsO!mslo#k@',action:action,bookingnumber:bookingnumber,remarks:remarks},function(data){
				...
				if(data.trim()=='success'){
					...
					$(document).off('hidden.bs.modal',modal).on('hidden.bs.modal',modal,function(){
						$(modal2).modal('hide');
						$(document).off('hidden.bs.modal',modal2).on('hidden.bs.modal',modal2,function(){

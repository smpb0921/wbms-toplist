...
$(document).off('change',tabsupplierRATE+' .fixedrateflag').on('change',tabsupplierRATE+' .fixedrateflag',function(){
		var modal = '#'+$(this).closest('.modal').attr('id');
		var type = $(modal+' .type').val();
		var fixedrateflag = $(this).prop('checked');
		showHidesupplierRateFields(modal,type,fixedrateflag);

});

/*$(document).off('change',tabsupplierRATE+' .pulloutflag').on('change',tabsupplierRATE+' .pulloutflag',function(){
		var modal = '#'+$(this).closest('.modal').attr('id');
...
$(document).off('click',tabsupplierRATE+' .editsupplierratebtn').on('click',tabsupplierRATE+' .editsupplierratebtn',function(){
	var modal = "#editsupplierratemodal";
	var rowid = $(this).attr('rowid')
	$(modal+' .supplierratemodalid').val(rowid);

	$.post(server+'supplier-rate.php',{supplierRateGetInfo:'kjoI$H2oiaah3h0$09jDppo92po@k@',id:rowid},function(data){
...
/***************************** SAVE | EDIT **************************************************/
$(document).off('click','.supplierratemodal-savebtn:not(".disabled")').on('click','.supplierratemodal-savebtn:not(".disabled")',function(){
	var modal = '#'+$(this).closest('.modal').attr('id'),
		tpl = $(modal+' .3pl').val(),
	...
	if(modal=='#editsupplierratemodal'){
		id = $(modal+' .supplierratemodalid').val();
		source = 'edit';
...
function showHidesupplierRateFields(modal,type,fixedrateflag){
	if(type=='PARCEL'){
...
$(document).off('change',tabsupplierRATE+' .type').on('change',tabsupplierRATE+' .type',function(){
...
$(document).off('click',tabsupplierRATE+' .viewsupplierratefreightchargebtn, '+tabsupplierRATE+' .viewpblfreightratebtn').on('click',tabsupplierRATE+' .viewsupplierratefreightchargebtn, '+tabsupplierRATE+' .viewpblfreightratebtn',function(){
	var modal = '#viewsupplierratefreightcharge';
	var supplierrateid = $(this).attr('rowid');
	$(modal+' #viewsupplierratefreightcharge-supplierrateid').val(supplierrateid);

	$(tabsupplierRATE+" #viewsupplierratefreightcharge-tbl").flexOptions({
...
$(document).off('click',tabsupplierRATE+' .viewsupplierratefreightcharge-insertratebtn:not(".disabled")').on('click',tabsupplierRATE+' .viewsupplierratefreightcharge-insertratebtn:not(".disabled")',function(){
		...
		var fromkg = $(modal+' .viewsupplierratefreightcharge-fromkg').val();
		var tokg = $(modal+' .viewsupplierratefreightcharge-tokg').val();
		var freightcharge = $(modal+' .viewsupplierratefreightcharge-freightcharge').val();
		var excessweightcharge = $(modal+' .viewsupplierratefreightcharge-excessweightcharge').val();

		var supplierrateid = $(modal+' #viewsupplierratefreightcharge-supplierrateid').val();




		if(fromkg==undefined||fromkg==null||fromkg==''||fromkg<0){
			$(modal+' .viewsupplierratefreightcharge-fromkg').focus();
			...
			$(modal+' .viewsupplierratefreightcharge-tokg').focus();
			...
			$(modal+' .viewsupplierratefreightcharge-freightcharge').focus();
			...
			$(modal+' .viewsupplierratefreightcharge-excessweightcharge').focus();
			...
			$('#loading-img').removeClass('hidden');
			$.post(server+'supplier-rate.php',{AddEditsupplierRateFreightCharge:'j$isnDPo#P3sll3p23a3!@3kzlsO!mslo#k@',supplierrateid:supplierrateid,fromkg:fromkg,tokg:tokg,freightcharge:freightcharge,excessweightcharge:excessweightcharge,source:'add'},function(data){
					if(data.trim()=='success'){
						//$(modal).modal('hide');
						//$(modal).on('hidden.bs.modal',function(){
						...
						$('#loading-img').addClass('hidden');
						$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Unable to add/edit supplier rate freight charge. No user permission.</div></div>");
						button.removeAttr('disabled').removeClass('disabled');
					}
					else{
						$('#loading-img').addClass('hidden');
...
$(document).off('click',tabsupplierRATE+' .editsupplierratefreightchargebtn').on('click',tabsupplierRATE+' .editsupplierratefreightchargebtn',function(){

	var modal = '#editsupplierratefreightchargemodal';
	...
	$(modal+' #supplierratefreightchargeID').val(freightchargeID);
	$(modal+' .editsupplierratefreightchargemodal-fromkg').val(fromkg);
	$(modal+' .editsupplierratefreightchargemodal-tokg').val(tokg);
	$(modal+' .editsupplierratefreightchargemodal-freightcharge').val(freightcharge);
	$(modal+' .editsupplierratefreightchargemodal-excessweightcharge').val(excessweightcharge);
	$(tabsupplierRATE+' '+modal).modal('show');


});

$(document).off('click',tabsupplierRATE+' .editsupplierratefreightchargemodal-savebtn:not("disabled")').on('click',tabsupplierRATE+' .editsupplierratefreightchargemodal-savebtn:not("disabled")',function(){
	var button = $(this);
		button.addClass("disabled");

	var supplierrateid = $('#viewsupplierratefreightcharge #viewsupplierratefreightcharge-supplierrateid').val();
	
	var modal = '#'+$(this).closest(".modal").attr('id');
	var freightchargeID = $(modal+' #supplierratefreightchargeID').val();
	var fromkg = $(modal+' .editsupplierratefreightchargemodal-fromkg').val();
	var tokg = $(modal+' .editsupplierratefreightchargemodal-tokg').val();
	var freightcharge = $(modal+' .editsupplierratefreightchargemodal-freightcharge').val();
	var excessweightcharge = $(modal+' .editsupplierratefreightchargemodal-excessweightcharge').val();


	if(fromkg==undefined||fromkg==null||fromkg==''||fromkg<0){
		$(modal+' .editsupplierratefreightchargemodal-fromkg').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide from (kg).</div></div>");
		button.removeClass('disabled');
	}
	else if(tokg==undefined||tokg==null||tokg==''||tokg<=0){
		$(modal+' .editsupplierratefreightchargemodal-tokg').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide to (kg).</div></div>");
		button.removeClass('disabled');
	}
	else if(freightcharge==undefined||freightcharge==null||freightcharge==''||freightcharge<=0){
		$(modal+' .editsupplierratefreightchargemodal-freightcharge').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide freight charge.</div></div>");
		button.removeClass('disabled');
	}
	else if(excessweightcharge==undefined||excessweightcharge==null||excessweightcharge==''||excessweightcharge<0){
		$(modal+' .editsupplierratefreightchargemodal-excessweightcharge').focus();
		$(modal+' .errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide excess weight charge.</div></div>");
		button.removeClass('disabled');
	}
	else{
		$('#loading-img').removeClass('hidden');
		$.post(server+'supplier-rate.php',{AddEditsupplierRateFreightCharge:'j$isnDPo#P3sll3p23a3!@3kzlsO!mslo#k@',supplierrateid:supplierrateid,freightchargeID:freightchargeID,fromkg:fromkg,tokg:tokg,freightcharge:freightcharge,excessweightcharge:excessweightcharge,source:'edit'},function(data){
				if(data.trim()=='success'){
					$(modal).modal('hide');
					$(modal).on('hidden.bs.modal',function(){
...
$(document).off('click',tabsupplierRATE+' .viewsupplierratefreightcharge-clearratefieldsbtn').on('click',tabsupplierRATE+' .viewsupplierratefreightcharge-clearratefieldsbtn',function(){
		var modal = '#'+$(this).closest('.modal').attr('id');
		$(modal+' .viewsupplierratefreightcharge-fromkg').val('');
		$(modal+' .viewsupplierratefreightcharge-tokg').val('');
		$(modal+' .viewsupplierratefreightcharge-freightcharge').val('');
		$(modal+' .viewsupplierratefreightcharge-excessweightcharge').val('');
		$(modal+' .viewsupplierratefreightcharge-fromkg').focus();
});
...
$(document).off('click',tabsupplierRATE+' #uploadsupplierratemodal-uploadbtn:not(".disabled")').on('click',tabsupplierRATE+' #uploadsupplierratemodal-uploadbtn:not(".disabled")',function(){

	var modal = '#uploadsupplierratemodal';
	var modal2 = '#supplierrate-uploadtransactionlogmodal';
	var form = '#uploadsupplierratemodal-form';
	var logframe = '#supplierrateuploadtransactionlogframe';
	var button = $(this);
	button.addClass('disabled');

	if($(tabsupplierRATE+' '+modal+' .uploadsupplierratemodal-file').val().trim()==''){
		...
		$(modal).modal('hide');
		$(document).off('hidden.bs.modal',tabsupplierRATE+' '+modal).on('hidden.bs.modal',tabsupplierRATE+' '+modal,function(){
			
			$(document).off('hidden.bs.modal',tabsupplierRATE+' '+modal);
			$(tabsupplierRATE+' '+modal2).modal('show');
			$(form).submit();

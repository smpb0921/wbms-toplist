...
$(document).off('click',contentWB+' #waybill-trans-newbtn:not(".disabled")').on('click',contentWB+' #waybill-trans-newbtn:not(".disabled")',function(){
	...
	$(contentWB+' .statusdiv').html('LOGGED');	
...
$(document).off('click',contentWB+' #waybill-trans-savebtn:not(".disabled")').on('click',contentWB+' #waybill-trans-savebtn:not(".disabled")',function(){
	...
	/*else if(deliverydate==''||checkDateFormat(deliverydate)!=1){
		...
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please select a shipper</div></div>");
		$('.content').animate({scrollTop:500},500);
		button.removeClass('disabled');
	}
	else if(shippercontact==''){
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide shipper contact person.</div></div>");
		$('.content').animate({scrollTop:500},500);
	...
	/*else if(shippertel==''){
		...
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please select a consignee</div></div>");
		$('.content').animate({scrollTop:500},500);
		button.removeClass('disabled');
	}
	else if(consigneeaccountname==''||consigneeaccountname==null){
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please select consignee</div></div>");
		$('.content').animate({scrollTop:500},500);
		button.removeClass('disabled');
	}
	/*else if(consigneecity==''){
		...
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide number of packages</div></div>");
		$('.content').animate({scrollTop:500},500);
		$(contentWB+' .waybill-numberofpackages').focus();
		button.removeClass('disabled');
	}
	else if(declaredvalue==''||declaredvalue<0){
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide declared value</div></div>");
		$('.content').animate({scrollTop:500},500);
		$(contentWB+' .waybill-declaredvalue').focus();
		button.removeClass('disabled');
	}
	else if(waybilltype=='PARCEL'&&(actualweight==''||!actualweight>0)){
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide actual weight</div></div>");
		$('.content').animate({scrollTop:500},500);
	...
	/*else if(chargeableweight==''||!chargeableweight>0){
		...
		$(contentWB+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please select mode of transport</div></div>");
		$('.content').animate({scrollTop:500},500);
		...
		if(response.trim()=='INVALID'){
			...
			if(data["status"]=="LOGGED"){
				...
				if(data["editwaybilldimensionsflag"]=='true'){
					allowothertrans += "<div class='button-group-btn active' title='Edit Dimensions' id='waybill-trans-editdimensionsbtn'><img src='../resources/img/edit2.png'></div>";
				}
				...
				$(contentWB+" .topbuttonswrapper .button-group").html("<div class='button-group-btn active' title='New' id='waybill-trans-newbtn'><img src='../resources/img/add.png'></div>"+allowothertrans+editbillingbtn+"<div class='button-group-btn active' title='Print' id='waybill-trans-printbtn'><img src='../resources/img/print.png'></div><div class='button-group-btn active' title='View Status History' id='waybill-trans-viewstatushistorybtn'><img src='../resources/img/history.png'></div>"+editchargesbtn+editcostingbtn);
				//<div class='button-group-btn active' title='Upload' id='waybill-trans-uploadbtn'><img src='../resources/img/upload.png'></div>
				userAccess();
			}
				...
				$(contentWB+" .topbuttonswrapper .button-group").html("<div class='button-group-btn active' title='New' id='waybill-trans-newbtn'><img src='../resources/img/add.png'></div>"+allowothertrans+"<div class='button-group-btn active' title='Print' id='waybill-trans-printbtn'><img src='../resources/img/print.png'></div><div class='button-group-btn active' title='View Status History' id='waybill-trans-viewstatushistorybtn'><img src='../resources/img/history.png'></div>");
				//<div class='button-group-btn active' title='Upload' id='waybill-trans-uploadbtn'><img src='../resources/img/upload.png'></div>
				userAccess();
			}
			else{
...
$(document).off('click',contentWB+' #waybillprintingmodal-savebtn:not(".disabled")').on('click',contentWB+' #waybillprintingmodal-savebtn:not(".disabled")',function(){
	...
	else */if(formtype!='EXTERNAL'&&formtype!='INTERNAL'){
		btn.removeClass('disabled');
...
$(document).off('click',contentWB+' #waybill-trans-editwaybillchargesbtn:not(".disabled")').on('click',contentWB+' #waybill-trans-editwaybillchargesbtn:not(".disabled")',function(){
	...
	$.post(server+'waybill.php',{getWaybillData:'F#@!3R3ksk#Op1NEi34smo1sonk&$',txnnumber:waybillnumber},function(response){
		...
		if(response.trim()=='INVALID'){
			...
			$(contentWB+" .editwaybillchargesmodal-chargeableweight").val(data["chargeableweight"]).number(true,4);
			$(contentWB+" .editwaybillchargesmodal-freight").val(data["freight"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-valuation").val(data["valuation"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-insurancerate").val(data["insurancerate"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-fuelrate").val(data["fuelrate"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-bunkerrate").val(data["bunkerrate"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-minimumrate").val(data["minimumrate"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-regularcharges").val(data["totalregularcharges"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-otherchargesvatable").val(data["totalotherchargesvatable"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-otherchargesnonvatable").val(data["totalotherchargesnonvatable"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-subtotal").val(data["subtotal"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-vat").val(data["vat"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-totalamount").val(data["totalamount"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-returndocumentfee").val(data["returndocumentfee"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-waybillfee").val(data["waybillfee"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-securityfee").val(data["securityfee"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-docstampfee").val(data["docstampfee"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-oda").val(data["oda"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-totalhandlingcharges").val(data["totalhandlingcharges"]).number(true,decimalplaces);
			$(contentWB+" .editwaybillchargesmodal-fixedrateamount").val(data["fixedrateamount"]).number(true,decimalplaces);
...
$(document).off('click',contentWB+' #waybill-trans-editdimensionsbtn:not(".disabled")').on('click',contentWB+' #waybill-trans-editdimensionsbtn:not(".disabled")',function(){
	...
	$(contentWB+' .packagedimensionsmodalflds').removeClass('hidden');
	$(contentWB+' .wbaddpackagecodebtnwrapper').empty();
	$(contentWB+' .waybill-vwcbm, '+contentWB+' .waybill-vw, '+contentWB+' .waybill-actualweight').removeAttr('disabled');

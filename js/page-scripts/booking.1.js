...
function enableFieldsBK(){
	...
	$(contentBK+' .searchbtn').addClass('disabled').removeClass('active').addClass('hidden');

	$(contentBK+' .topbuttonsdiv').empty().html("<div class='padded-with-border-engraved topbuttonswrapper'><div class='button-group'><div class='button-group-btn active' title='Save' id='booking-trans-savebtn'><img src='../resources/img/save.png'></div><div class='button-group-btn active' title='Cancel' id='booking-trans-cancelbtn'><img src='../resources/img/cancel.png'></div></div></div>");
	$(contentBK+' .savecancelbuttonwrapper').html("<div class='padded-with-border-engraved button-bottom'><div class='button-group'><div class='button-group-btn active' id='booking-trans-savebtn'><img src='../resources/img/save.png'>&nbsp;&nbsp;Save</div><div class='button-group-btn active' id='booking-trans-cancelbtn'><img src='../resources/img/cancel.png'>&nbsp;&nbsp;Cancel</div></div></div>");
...
function disableFieldsBK(){
	...
	$(contentBK+' .searchbtn').removeClass('disabled').addClass('active').removeClass('hidden');
...
function clearAllBK(){
	...
	$(inputfieldsBK+' textarea').text('').val('');
	$(inputfieldsBK+' select').val('').trigger('change');
...
/************* NEW BTN *********************/
$(document).off('click',contentBK+' #booking-trans-newbtn:not(".disabled")').on('click',contentBK+' #booking-trans-newbtn:not(".disabled")',function(){
	processBK = 'add';
	enableFieldsBK();
	clearAllBK();
	...
	$(contentBK+' #pgtxnbooking-id').val('').removeAttr('pgtxnbooking-number');
	...
	$(contentBK+" .booking-shipper-pickupcountry").empty().append('<option selected value="Philippines">Philippines</option>').trigger('change');
		...
		$.post("../config/post-functions.php",{defaulDoortoDoor:'oiskus49Fnla3#Oih4noiI$IO@Y#*h@o3sk'},function(data){
				...
				if(data['response']=='success'){
					if(data["service"].trim()!=null){
						$(inputfieldsBK+" .booking-services").empty().append('<option selected value="'+data["serviceid"]+'">'+data["service"]+'</option>').trigger('change');
					}
					else{
						$(inputfieldsBK+" .booking-services").empty().trigger('change');
					}
				}
...
/************* EDIT BTN *********************/
$(document).off('click',contentBK+' #booking-trans-editbtn:not(".disabled")').on('click',contentBK+' #booking-trans-editbtn:not(".disabled")',function(){
	processBK = 'edit';
	enableFieldsBK();
...
/************* POST BTN *********************/
$(document).off('click',contentBK+' #booking-trans-postbtn:not(".disabled")').on('click',contentBK+' #booking-trans-postbtn:not(".disabled")',function(){
...
/************** CANCEL BTN *******************/
$(document).off('click',contentBK+' #booking-trans-cancelbtn:not(".disabled")').on('click',contentBK+' #booking-trans-cancelbtn:not(".disabled")',function(){
	processBK = '';
	...
	if(currentBookingTxn!=''){
		...
		$(contentBK+' .topbuttonsdiv').html("<div class='padded-with-border-engraved topbuttonswrapper'><div class='button-group'><div class='button-group-btn active' title='New' id='booking-trans-newbtn'><img src='../resources/img/add.png'></div></div></div>");
	}
	$(contentBK+' .vehicleinformationsection').removeClass('hidden');
...
/************** SAVE BTN *******************/
$(document).off('click',contentBK+' #booking-trans-savebtn:not(".disabled")').on('click',contentBK+' #booking-trans-savebtn:not(".disabled")',function(){
	...
	var button = $(this),
	    ...
	    vw = 0;//$(inputfieldsBK+' .booking-vw').val(),
	    ...
	    mode = $(inputfieldsBK+' .booking-modeoftransport').find('option:selected').text(),
	    source = processBK,
	...
	/*else if(shippertel==''){
		...
		$(inputfieldsBK+' .detail-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Please provide pickup region/province.</div></div>");
		$('.content').animate({scrollTop:500},500);
								...
								confirm: function(){
									...
									$.post(server+'booking.php',{SaveBookingTransaction:'oi$ha@3h0$0jRoihQnsRP9$nzpo92po@k@',timeready:timeready,platenumber:platenumber,id:id,origin:origin,destination:destination,pickupdate:pickupdate,remarks:remarks,shipperid:shipperid,shipperaccountnumber:shipperaccountnumber,shipperaccountname:shipperaccountname,shippertel:shippertel,shippercompanyname:shippercompanyname,shipperstreet:shipperstreet,shipperdistrict:shipperdistrict,shippercity:shippercity,shipperprovince:shipperprovince,shipperzipcode:shipperzipcode,shippercountry:shippercountry,pickupstreet:pickupstreet,pickupdistrict:pickupdistrict,pickupcity:pickupcity,pickupprovince:pickupprovince,pickupzipcode:pickupzipcode,pickupcountry:pickupcountry,consigneeid:consigneeid,consigneeaccountnumber:consigneeaccountnumber,consigneeaccountname:consigneeaccountname,consigneetel:consigneetel,consigneecompanyname:consigneecompanyname,consigneestreet:consigneestreet,consigneedistrict:consigneedistrict,consigneecity:consigneecity,consigneeprovince:consigneeprovince,consigneezipcode:consigneezipcode,consigneecountry:consigneecountry,numberofpackage:numberofpackage,declaredvalue:declaredvalue,actualweight:actualweight,vwcbm:vwcbm,amount:amount,services:services,modeoftransport:modeoftransport,handlinginstruction:handlinginstruction,paymode:paymode,shipmentdescription:shipmentdescription,source:source,vw:vw,uom:uom,shippermobile:shippermobile,shippercontact:shippercontact,bkdocument:bkdocument,samedaypickupflag:samedaypickupflag,drivercontact:drivercontact,billto:billto,driver:driver,helper:helper,vehicletype:vehicletype,vehicletypetype:vehicletypetype},function(data){
										...
										if(data['response']=='success'){
											...
											$(inputfieldsBK+' .header-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Invalid pickup date.</div></div>");
											$('.content').animate({scrollTop:0},500);
											$(inputfieldsBK+' .booking-pickupdate').focus();
											$('#loading-img').addClass('hidden');
											button.removeClass('disabled');
...
$(document).off('click',contentBK+' #booking-trans-updatestatpickedbtn:not(".disabled")').on('click',contentBK+' #booking-trans-updatestatpickedbtn:not(".disabled")',function(){
...
/************************* VOID BTN ***********************/
$(document).off('click',contentBK+' #booking-trans-voidbtn:not(".disabled")').on('click',contentBK+' #booking-trans-voidbtn:not(".disabled")',function(){
...
/*************** INPUT GROUP BUTTONS ****************************/
$(document).off('click',contentBK+' .inputgroupicon:not(".disabled")').on('click',contentBK+' .inputgroupicon:not(".disabled")',function(){
...
$(document).off('click',contentBK+' #booking-pickupaddresslookupbtn:not(".disabled")').on('click',contentBK+' #booking-pickupaddresslookupbtn:not(".disabled")',function(){
	var modal = $(this).data('modal');
...
/********************* TABLEROW EVENTS ********************************/
$(document).off('dblclick',contentBK+' .shipperlookuprow:not(".disabled")').on('dblclick',contentBK+' .shipperlookuprow:not(".disabled")',function(){
		...
		$.post(server+'shipper.php',{ShipperGetInfo:'kjoI$H2oiaah3h0$09jDppo92po@k@',id:id},function(data){
			...
			if(rsp['response']=='success'){
				...
				if(rsp["companydistrict"]!=null){
			        $(inputfieldsBK+" .booking-shipper-district").empty().append('<option selected value="'+rsp["companydistrict"]+'">'+rsp["companydistrict"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-shipper-district").empty().trigger('change');
			    }
			    if(rsp["companycity"]!=null){
			        $(inputfieldsBK+" .booking-shipper-city").empty().append('<option selected value="'+rsp["companycity"]+'">'+rsp["companycity"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-shipper-city").empty().trigger('change');
			    }
			    if(rsp["companyprovince"]!=null){
			        $(inputfieldsBK+" .booking-shipper-province").empty().append('<option selected value="'+rsp["companyprovince"]+'">'+rsp["companyprovince"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-shipper-province").empty().trigger('change');
			    }
			    if(rsp["companyzipcode"]!=null){
			        $(inputfieldsBK+" .booking-shipper-zipcode").empty().append('<option selected value="'+rsp["companyzipcode"]+'">'+rsp["companyzipcode"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-shipper-zipcode").empty().trigger('change');
			    }
				
				if(rsp["companycountry"]!=null){
			        $(inputfieldsBK+" .booking-shipper-country").empty().append('<option selected value="'+rsp["companycountry"]+'">'+rsp["companycountry"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-shipper-country").empty().trigger('change');
			    }

			    if(rsp["paymode"]!=null){
			        $(inputfieldsBK+" .booking-paymode").empty().append('<option selected value="'+rsp["paymode"]+'">'+rsp["paymode"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-paymode").empty().trigger('change');
			    }
			    	...
			    	$.post(server+'booking.php',{ShipperDefaultPickupAddressGetInfo:'ooi3h$9apsojespriaoi#@po92po@k@',id:id},function(data2){
			    		...
			    		if(rsp2['response']=='success'){
							...
							if(rsp2["district"]!=null){
						        $(inputfieldsBK+" .booking-shipper-pickupdistrict").empty().append('<option selected value="'+rsp2["district"]+'">'+rsp2["district"]+'</option>').trigger('change');
						    }
						    else{
						        $(inputfieldsBK+" .booking-shipper-pickupdistrict").empty().trigger('change');
						    }
						    if(rsp2["city"]!=null){
						        $(inputfieldsBK+" .booking-shipper-pickupcity").empty().append('<option selected value="'+rsp2["city"]+'">'+rsp2["city"]+'</option>').trigger('change');
						    }
						    else{
						        $(inputfieldsBK+" .booking-shipper-pickupcity").empty().trigger('change');
						    }
						    if(rsp2["province"]!=null){
						        $(inputfieldsBK+" .booking-shipper-pickupprovince").empty().append('<option selected value="'+rsp2["province"]+'">'+rsp2["province"]+'</option>').trigger('change');
						    }
						    else{
						        $(inputfieldsBK+" .booking-shipper-pickupprovince").empty().trigger('change');
						    }
						    if(rsp2["zipcode"]!=null){
						        $(inputfieldsBK+" .booking-shipper-pickupzipcode").empty().append('<option selected value="'+rsp2["zipcode"]+'">'+rsp2["zipcode"]+'</option>').trigger('change');
						    }
						    else{
						        $(inputfieldsBK+" .booking-shipper-pickupzipcode").empty().trigger('change');
						    }

							if(rsp2["country"]!=null){
						        $(inputfieldsBK+" .booking-shipper-pickupcountry").empty().append('<option selected value="'+rsp2["country"]+'">'+rsp2["country"]+'</option>').trigger('change');
						    }
						    else{
						        $(inputfieldsBK+" .booking-shipper-pickupcountry").empty().trigger('change');
						    }
				    		row.removeClass('disabled');
				    	}
...
$(document).off('dblclick',contentBK+' .shipperpickupaddresslookuprow:not(".disabled")').on('dblclick',contentBK+' .shipperpickupaddresslookuprow:not(".disabled")',function(){
	...
	$(document).on('hidden.bs.modal',contentBK+' '+modal,function(){
		...
		if(row.find("td[abbr='pickup_district'] div").text().trim()!=null&&row.find("td[abbr='pickup_district'] div").text().trim()!=''){
			$(inputfieldsBK+" .booking-shipper-pickupdistrict").empty().append('<option selected value="'+row.find("td[abbr='pickup_district'] div").text()+'">'+row.find("td[abbr='pickup_district'] div").text()+'</option>').trigger('change');
		}
		else{
		    $(inputfieldsBK+" .booking-shipper-pickupdistrict").empty().trigger('change');
		}
		if(row.find("td[abbr='pickup_city'] div").text().trim()!=null&&row.find("td[abbr='pickup_city'] div").text().trim()!=''){
			$(inputfieldsBK+" .booking-shipper-pickupcity").empty().append('<option selected value="'+row.find("td[abbr='pickup_city'] div").text()+'">'+row.find("td[abbr='pickup_city'] div").text()+'</option>').trigger('change');
		}
		else{
		    $(inputfieldsBK+" .booking-shipper-pickupcity").empty().trigger('change');
		}
		if(row.find("td[abbr='pickup_state_province'] div").text().trim()!=null&&row.find("td[abbr='pickup_state_province'] div").text().trim()!=''){
			$(inputfieldsBK+" .booking-shipper-pickupprovince").empty().append('<option selected value="'+row.find("td[abbr='pickup_state_province'] div").text()+'">'+row.find("td[abbr='pickup_state_province'] div").text()+'</option>').trigger('change');
		}
		else{
		    $(inputfieldsBK+" .booking-shipper-pickupprovince").empty().trigger('change');
		}
		if(row.find("td[abbr='pickup_zip_code'] div").text().trim()!=null&&row.find("td[abbr='pickup_zip_code'] div").text().trim()!=''){
			$(inputfieldsBK+" .booking-shipper-pickupzipcode").empty().append('<option selected value="'+row.find("td[abbr='pickup_zip_code'] div").text()+'">'+row.find("td[abbr='pickup_zip_code'] div").text()+'</option>').trigger('change');
		}
		else{
		    $(inputfieldsBK+" .booking-shipper-pickupzipcode").empty().trigger('change');
		}
		if(row.find("td[abbr='pickup_country'] div").text().trim()!=null&&row.find("td[abbr='pickup_country'] div").text().trim()!=''){
			$(inputfieldsBK+" .booking-shipper-pickupcountry").empty().append('<option selected value="'+row.find("td[abbr='pickup_country'] div").text()+'">'+row.find("td[abbr='pickup_country'] div").text()+'</option>').trigger('change');
		}
		else{
		    $(inputfieldsBK+" .booking-shipper-pickupcountry").empty().trigger('change');
		}
...
$(document).off('dblclick',contentBK+' .consigneelookuprow:not(".disabled")').on('dblclick',contentBK+' .consigneelookuprow:not(".disabled")',function(){
	var id = $(this).attr('rowid');
	var modal = '#'+$(this).closest('.modal').attr('id');
	var row = $(this);
	row.addClass('disabled');
		...
		$.post(server+'consignee.php',{ConsigneeGetInfo:'kjoI$H2oiaah3h0$09jDppo92po@k@',id:id},function(data){
			...
			if(rsp['response']=='success'){
				...
				if(rsp["district"]!=null){
			        $(inputfieldsBK+" .booking-consignee-district").empty().append('<option selected value="'+rsp["district"]+'">'+rsp["district"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-consignee-district").empty().trigger('change');
			    }
			    if(rsp["city"]!=null){
			        $(inputfieldsBK+" .booking-consignee-city").empty().append('<option selected value="'+rsp["city"]+'">'+rsp["city"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-consignee-city").empty().trigger('change');
			    }
			    if(rsp["zipcode"]!=null){
			        $(inputfieldsBK+" .booking-consignee-zipcode").empty().append('<option selected value="'+rsp["zipcode"]+'">'+rsp["zipcode"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-consignee-zipcode").empty().trigger('change');
			    }
			    if(rsp["province"]!=null){
			        $(inputfieldsBK+" .booking-consignee-province").empty().append('<option selected value="'+rsp["province"]+'">'+rsp["province"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-consignee-province").empty().trigger('change');
			    }
				if(rsp["country"]!=null){
			        $(inputfieldsBK+" .booking-consignee-country").empty().append('<option selected value="'+rsp["country"]+'">'+rsp["country"]+'</option>').trigger('change');
			    }
			    else{
			        $(inputfieldsBK+" .booking-consignee-country").empty().trigger('change');
			    }
...
$(document).off('show.bs.modal',contentBK+' #booking-shipperpickupaddresslookup').on('show.bs.modal',contentBK+' #booking-shipperpickupaddresslookup',function(){

	var modal = '#'+$(this).attr('id');
	var selectedshipperID = $(modal+' .booking-shipperpickupaddresslookup-shipperid').val(); 
	$(contentBK+" #booking-shipperpickupaddresslookuptbl").flexOptions({
	...
	$.post(server+'booking.php',{checkIfUserCanAddPickupAddress:'dROi$nsFpo94dnels$4sRoi809srbmouS@1!'},function(data){
			if(data.trim()=='1'){
				$(contentBK+" .booking-shipperpickupaddresslookup-country").empty().append('<option selected value="Philippines">Philippines</option>').trigger('change');
...
/*********************** MODAL BUTTONS *************************************/
$(document).off('click',contentBK+' #booking-shipperpickupaddress-savebtn:not(".disabled")').on('click',contentBK+' #booking-shipperpickupaddress-savebtn:not(".disabled")',function(){
	var modal = '#'+$(this).closest('.modal').attr('id'),
...
$(document).off('click',contentBK+' #booking-updatestattopickedmodal-savebtn:not(".disabled")').on('click',contentBK+' #booking-updatestattopickedmodal-savebtn:not(".disabled")',function(){
	...
	if(status==''||status==null||status=='NULL'||status==undefined||status=='null'){
		...
		$.confirm({
				...
				confirm: function(){
					$('#loading-img').removeClass('hidden');
					$.post(server+'booking.php',{updateStatusPickedUp:'kkjO#@siaah3h0$09odfj$owenxezpo92po@k@',bookingid:bookingid,actualpickupdate:actualpickupdate,pickedupby:pickedupby,remarks:remarks,status:status},function(data){
						...
						if(data.trim()=='success'){
							...
							$(modal+' .modal-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Invalid actual pickup date.</div></div>");
							$(modal+' .booking-updatestattopickedmodal-actualpickupdate').focus();
							button.removeClass('disabled');
							$('#loading-img').addClass('hidden');
						}
...
$(document).off('click',contentBK+' #voidbookingtransactionmodal-savebtn:not(".disabled")').on('click',contentBK+' #voidbookingtransactionmodal-savebtn:not(".disabled")',function(){
	...
	if(remarks.trim()==''){
		...
		$.confirm({
				...
				confirm: function(){
					$('#loading-img').removeClass('hidden');
					$.post(server+'booking.php',{voidBookingTransaction:'dROi$nsFpo94dnels$4sRoi809srbmouS@1!',bookingid:bookingid,bookingnumber:bookingnumber,remarks:remarks},function(data){
...
/********************* VIEWING *********************************/
$(document).off('click',contentBK+" .firstprevnextlastbtn button:not('.disabled')").on('click',contentBK+" .firstprevnextlastbtn button:not('.disabled')",function(){
	$('#loading-img').removeClass('hidden');
...
$(document).off('keyup',contentBK+' .transactionnumber').on('keyup',contentBK+' .transactionnumber',function(e){
	e.preventDefault();
	$('#loading-img').removeClass('hidden');
...
function getBookingInformation(txnnumber){
	...
	$.post(server+'booking.php',{getBookingData:'F#@!3R3ksk#Op1NEi34smo1sonk&$',txnnumber:txnnumber},function(response){
		...
		if(response.trim()=='INVALID'){
			...
			$(contentBK+" #pgtxnbooking-id").val(data["id"]).attr('pgtxnbooking-number',txnnumber);
			...
			if(data["platenumber"]!=null){
				$(inputfieldsBK+" .booking-platenumber").empty().append('<option selected value="'+data["platenumber"]+'">'+data["platenumber"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-platenumber").empty().trigger('change');
			}


			if(data["driver"]!=null){
				$(inputfieldsBK+" .booking-driver").empty().append('<option selected value="'+data["driver"]+'">'+data["driver"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-driver").empty().trigger('change');
			}

			if(data["helper"]!=null){
				$(inputfieldsBK+" .booking-helper").empty().append('<option selected value="'+data["helper"]+'">'+data["helper"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-helper").empty().trigger('change');
			}

			if(data["vehicletypeid"]!=null){
				$(inputfieldsBK+" .booking-vehicletype").empty().append('<option selected value="'+data["vehicletypeid"]+'">'+data["vehicletype"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-vehicletype").empty().trigger('change');
			}

			if(data["uom"]!=null){
				$(inputfieldsBK+" .booking-uom").empty().append('<option selected value="'+data["uom"]+'">'+data["uom"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-uom").empty().trigger('change');
			}

			if(data["origin"]!=null){
				$(inputfieldsBK+" .booking-origin").empty().append('<option selected value="'+data["originid"]+'">'+data["origin"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-origin").empty().trigger('change');
			}

			if(data["destination"]!=null){
				$(inputfieldsBK+" .booking-destination").empty().append('<option selected value="'+data["destinationid"]+'">'+data["destination"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-destination").empty().trigger('change');
			}


			if(data["shipperdistrict"]!=null){
				$(inputfieldsBK+" .booking-shipper-district").empty().append('<option selected value="'+data["shipperdistrict"]+'">'+data["shipperdistrict"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-district").empty().trigger('change');
			}
			if(data["shippercity"]!=null){
				$(inputfieldsBK+" .booking-shipper-city").empty().append('<option selected value="'+data["shippercity"]+'">'+data["shippercity"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-city").empty().trigger('change');
			}
			if(data["shipperzipcode"]!=null){
				$(inputfieldsBK+" .booking-shipper-zipcode").empty().append('<option selected value="'+data["shipperzipcode"]+'">'+data["shipperzipcode"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-zipcode").empty().trigger('change');
			}
			if(data["shipperprovince"]!=null){
				$(inputfieldsBK+" .booking-shipper-province").empty().append('<option selected value="'+data["shipperprovince"]+'">'+data["shipperprovince"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-province").empty().trigger('change');
			}
			...
			if(data["shippercountry"]!=null){
				$(inputfieldsBK+" .booking-shipper-country").empty().append('<option selected value="'+data["shippercountry"]+'">'+data["shippercountry"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-country").empty().trigger('change');
			}
			...
			if(data["pickupdistrict"]!=null){
				$(inputfieldsBK+" .booking-shipper-pickupdistrict").empty().append('<option selected value="'+data["pickupdistrict"]+'">'+data["pickupdistrict"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-pickupdistrict").empty().trigger('change');
			}
			if(data["pickupcity"]!=null){
				$(inputfieldsBK+" .booking-shipper-pickupcity").empty().append('<option selected value="'+data["pickupcity"]+'">'+data["pickupcity"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-pickupcity").empty().trigger('change');
			}
			if(data["pickupzipcode"]!=null){
				$(inputfieldsBK+" .booking-shipper-pickupzipcode").empty().append('<option selected value="'+data["pickupzipcode"]+'">'+data["pickupzipcode"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-pickupzipcode").empty().trigger('change');
			}
			if(data["pickupprovince"]!=null){
				$(inputfieldsBK+" .booking-shipper-pickupprovince").empty().append('<option selected value="'+data["pickupprovince"]+'">'+data["pickupprovince"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-pickupprovince").empty().trigger('change');
			}
			...
			if(data["pickupcountry"]!=null){
				$(inputfieldsBK+" .booking-shipper-pickupcountry").empty().append('<option selected value="'+data["pickupcountry"]+'">'+data["pickupcountry"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-shipper-pickupcountry").empty().trigger('change');
			}
			...
			if(data["consigneedistrict"]!=null){
				$(inputfieldsBK+" .booking-consignee-district").empty().append('<option selected value="'+data["consigneedistrict"]+'">'+data["consigneedistrict"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-consignee-district").empty().trigger('change');
			}
			if(data["consigneecity"]!=null){
				$(inputfieldsBK+" .booking-consignee-city").empty().append('<option selected value="'+data["consigneecity"]+'">'+data["consigneecity"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-consignee-city").empty().trigger('change');
			}
			if(data["consigneezipcode"]!=null){
				$(inputfieldsBK+" .booking-consignee-zipcode").empty().append('<option selected value="'+data["consigneezipcode"]+'">'+data["consigneezipcode"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-consignee-zipcode").empty().trigger('change');
			}
			if(data["consigneeprovince"]!=null){
				$(inputfieldsBK+" .booking-consignee-province").empty().append('<option selected value="'+data["consigneeprovince"]+'">'+data["consigneeprovince"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-consignee-province").empty().trigger('change');
			}
			if(data["consigneecountry"]!=null){
				$(inputfieldsBK+" .booking-consignee-country").empty().append('<option selected value="'+data["consigneecountry"]+'">'+data["consigneecountry"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-consignee-country").empty().trigger('change');
			}
			...
			if(data["modeoftransport"]!=null){
				$(inputfieldsBK+" .booking-modeoftransport").empty().append('<option selected value="'+data["modeoftransportid"]+'">'+data["modeoftransport"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-modeoftransport").empty().trigger('change');
			}
			...
			if(data["paymode"]!=null){
				$(inputfieldsBK+" .booking-paymode").empty().append('<option selected value="'+data["paymode"]+'">'+data["paymode"]+'</option>').trigger('change');
			}
			else{
				$(inputfieldsBK+" .booking-paymode").empty().trigger('change');
			}
			...
			$.post(server+'booking.php',{getHandlingInstructions:'sdfed#n2L1hfi$n#opi3opod30napri',txnnumber:txnnumber},function(data){
				...
				for (var i = 0; i < instructions.length; i++) {
					...
					if(strdesc[1]!=null){
						$(inputfieldsBK+" .booking-handlinginstruction").append('<option selected value="'+strdesc[0]+'">'+strdesc[1]+'</option>').trigger('change');
					}
					else{
			...
			$.post(server+'booking.php',{getAccompanyingDocuments:'sdfed#n2L1hfi$n#opi3opod30napri',txnnumber:txnnumber},function(data){
				...
				for (var i = 0; i < descriptions.length; i++) {
					var strdesc = descriptions[i];
					    strdesc = strdesc.split('%$&');
					if(strdesc[1]!=null){
						$(inputfieldsBK+" .booking-document").append('<option selected value="'+strdesc[0]+'">'+strdesc[1]+'</option>').trigger('change');
					}
					else{
...
$(document).off('dblclick',contentBK+' .bookingsearchrow').on('dblclick',contentBK+' .bookingsearchrow',function(){
	var modal = '#'+$(this).closest('.modal').attr('id');
...
function searchBookingLookup(modal){
	var status = $(modal+' .bookingsearch-status').val().replace(/\s/g,'%20'),
	   ...
	   $(contentBK+' #bookingsearch-table').flexOptions({
											url:'loadables/ajax/transactions.booking-search.php?status='+status+'&origin='+origin+'&destination='+destination+'&shipper='+shipper+'&consignee='+consignee+'&pickupdatefrom='+pickupdatefrom+'&pickupdateto='+pickupdateto+'&pickupcity='+pickupcity+'&pickupregion='+pickupregion,
...
$(document).off('click',contentBK+' #bookingsearch-searchbtn:not(".disabled")').on('click',contentBK+' #bookingsearch-searchbtn:not(".disabled")',function(){
...
/************************** SEARCHING - END ********************************/
				...
				$(document).off('change',contentBK+' .booking-shipper-pickupprovince').on('change',contentBK+' .booking-shipper-pickupprovince',function(){
					...
					if(processBK=='edit'||processBK=='add'){
					    ...
					    $(wrapper).find(".booking-shipper-pickupcity").select2({
					            ajax: {
				...
				$(document).off('change',contentBK+' .booking-shipper-pickupcity').on('change',contentBK+' .booking-shipper-pickupcity',function(){
					if(processBK=='edit'||processBK=='add'){
						var wrapper = $(this).closest('.addressgroupwrapper');
						var city = $(this).val();

					 	$(wrapper).find(".booking-shipper-pickupdistrict").select2({
					            ajax: {
				...
				$(document).off('change',contentBK+' .booking-shipper-pickupdistrict').on('change',contentBK+' .booking-shipper-pickupdistrict',function(){
					if(processBK=='edit'||processBK=='add'){
						var wrapper = $(this).closest('.addressgroupwrapper');
						var district = $(this).val();
						var city = $(this).closest('.addressgroupwrapper').find('.booking-shipper-pickupcity').val();

					 	$(wrapper).find(".booking-shipper-pickupzipcode").select2({
					            ajax: {
					 	...
					 	$.post(configfldr+'post-functions.php',{getZipCode:'Fns!oi3ah434ad#2l211#$*3%',district:district,city:city},function(data){
						 	 if(data.trim()!=''){
									$(contentBK+" .booking-shipper-pickupzipcode").empty().append('<option selected value="'+data+'">'+data+'</option>').trigger('change');
...
$(document).off('change',contentBK+' .booking-modeoftransport').on('change',contentBK+' .booking-modeoftransport',function(){

		if(processBK=='add'||processBK=='edit'){
			var mode = $(this).find('option:selected').text();
			if(mode.indexOf("FTL")>=0||mode.indexOf("FCL")>=0){
				$(contentBK+' .booking-actualweight, '+contentBK+' .booking-numberofpackages, '+contentBK+' .booking-vwcbm').addClass('alwaysdisabled').attr('disabled','').val(0);
			}
			else{
				$(contentBK+' .booking-actualweight, '+contentBK+' .booking-numberofpackages, '+contentBK+' .booking-vwcbm').removeClass('alwaysdisabled').removeAttr('disabled');
			}
		}
...
$(document).off('change',contentBK+' .booking-samedaypickupflag').on('change',contentBK+' .booking-samedaypickupflag',function(){
	if(processBK=='add'||processBK=='edit'){
		var flag = $(this).prop("checked");
		if(flag==true){
			$(contentBK+' .booking-pickupdate').val('').attr('disabled',true);

			$(contentBK+' .booking-pickupdate').datepicker("setDate", new Date());
		}
		else{
			$(contentBK+' .booking-pickupdate').val('').removeAttr('disabled');
		}
	}
...
/************************* PRINTING *****************************************/
$(document).off('click',contentBK+' #booking-trans-printbtn').on('click',contentBK+' #booking-trans-printbtn',function(){
	...
	if($(".content>.content-tab-pane .content-tabs").find("li[data-pane='#"+tabid+"tabpane']").length>=1){
		...
		$('.content>.content-tab-pane .content-pane-wrapper>.content-pane:last-child').load("Printouts/print-preview.php?source=printouts/transactions/booking.php?txnnumber="+tabid+'&reference='+tabid);
		setTimeout(function(){
			$('#loading-img').addClass('hidden');
		},400);
	}
...
$(document).off('click',contentBK+' #booking-shipperinfobtn:not(".disabled")').on('click',contentBK+' #booking-shipperinfobtn:not(".disabled")',function(){
	var button = $(this);
	button.addClass('disabled');
...
$(document).off('select2:select',contentBK+' .booking-vehicletype').on('select2:select',contentBK+' .booking-vehicletype',function(e){
    		var vehicletype = $(this).val();
    		var type = e.params.data['data-type'];
    		$(contentBK+' .booking-vehicletypetype').val(type);

   			$(contentBK+" .driverdropdownselect").empty().trigger('change').select2({
		            ajax: {
		    ...
		    $(contentBK+" .helperdropdownselect").empty().trigger('change').select2({
		            ajax: {
		    ...
		    if((processBK=='add'||processBK=='edit')&&(vehicletype==''||vehicletype=='null'||vehicletype==null||vehicletype=='NULL'||vehicletype==undefined)){
		    	$(contentBK+" .driverdropdownselect").empty().trigger('change');
		    	$(contentBK+" .helperdropdownselect").empty().trigger('change');
		    	$(contentBK+" .vehicledropdownselect").empty().trigger('change');
		    	$(contentBK+" .booking-drivercontactnumber").val('');
		    }
});


$(document).off('select2:select',contentBK+' .booking-driver').on('select2:select',contentBK+' .booking-driver',function(e){
...
$(document).off('select2:select',contentBK+' .booking-assigndriverdetailsmodal-driver').on('select2:select',contentBK+' .booking-assigndriverdetailsmodal-driver',function(e){
    		var contact = e.params.data['contactnumber'];
...
$(document).off('click',contentBK+" #booking-trans-assigndriverbtn:not('.disabled')").on('click',contentBK+" #booking-trans-assigndriverbtn:not('.disabled')",function(){
	...
	$.post(server+'booking.php',{getBookingData:'F#@!3R3ksk#Op1NEi34smo1sonk&$',txnnumber:bookingnumber},function(response){
		...
		if(response.trim()=='INVALID'){
			...
			$(document).off('shown.bs.modal',modal).on('shown.bs.modal',modal,function(){
					...
					if(data["platenumber"]!=null){
						$(contentBK+" .booking-assigndriverdetailsmodal-platenumber").empty().append('<option selected value="'+data["platenumber"]+'">'+data["platenumber"]+'</option>').trigger('change');
					}
					else{
						$(contentBK+" .booking-assigndriverdetailsmodal-platenumber").empty().trigger('change');
					}

					if(data["driver"]!=null){
						$(contentBK+" .booking-assigndriverdetailsmodal-driver").empty().append('<option selected value="'+data["driver"]+'">'+data["driver"]+'</option>').trigger('change');
					}
					else{
						$(contentBK+" .booking-assigndriverdetailsmodal-driver").empty().trigger('change');
					}

					if(data["helper"]!=null){
						$(contentBK+" .booking-assigndriverdetailsmodal-helper").empty().append('<option selected value="'+data["helper"]+'">'+data["helper"]+'</option>').trigger('change');
					}
					else{
						$(contentBK+" .booking-assigndriverdetailsmodal-helper").empty().trigger('change');
					}
...
$(document).off('click',contentBK+" #booking-assigndriverdetailsmodal-savebtn:not('.disabled')").on('click',contentBK+" #booking-assigndriverdetailsmodal-savebtn:not('.disabled')",function(){
	...
	if(platenumber==''||platenumber==null||platenumber=='null'||platenumber=='NULL'||platenumber==undefined){
		...
		$('#loading-img').removeClass('hidden');
		$.post(server+'booking.php',{confirmDriverDetails:'sdf#io2s9$dlIP$psLn!#oid($)soep$8%syo7',bookingid:bookingid,platenumber:platenumber,driver:driver,helper:helper,drivercontactnumber:drivercontactnumber,timeready:timeready},function(response){
			...
			if(data=='NULL'){
				...
				if(data['response']=='success'){
					...
					$(modal+' .modal-errordiv').html("<div class='message'><div class='message-content'><span class='closemessage'>&times;</span>Invalid Time Ready. Please provide valid date and time.</div></div>");
					$(modal+' .booking-assigndriverdetailsmodal-timeready').focus();
					btn.removeClass('disabled');
					$('#loading-img').addClass('hidden');
...
$(document).off('click',contentBK+" #booking-trans-updatestatusbtn:not('.disabled')").on('click',contentBK+" #booking-trans-updatestatusbtn:not('.disabled')",function(){
			...
			$.post(server+'booking.php',{getBookingData:'F#@!3R3ksk#Op1NEi34smo1sonk&$',txnnumber:bookingnumber},function(response){
				...
				if(response.trim()=='INVALID'){
					...
					$(document).off('shown.bs.modal',modal).on('shown.bs.modal',modal,function(){
							...
							if(data["driver"]!=null){
								$(contentBK+" .booking-updatebookingstatusmodal-driver").empty().append('<option selected value="'+data["driver"]+'">'+data["driver"]+'</option>').trigger('change');
							}
							else{
								$(contentBK+" .booking-updatebookingstatusmodal-driver").empty().trigger('change');
							}

							if(data["helper"]!=null){
								$(contentBK+" .booking-updatebookingstatusmodal-helper").empty().append('<option selected value="'+data["helper"]+'">'+data["helper"]+'</option>').trigger('change');
							}
							else{
								$(contentBK+" .booking-updatebookingstatusmodal-helper").empty().trigger('change');
							}

							if(data["platenumber"]!=null){
								$(contentBK+" .booking-updatebookingstatusmodal-platenumber").empty().append('<option selected value="'+data["platenumber"]+'">'+data["platenumber"]+'</option>').trigger('change');
							}
							else{
								$(contentBK+" .booking-updatebookingstatusmodal-platenumber").empty().trigger('change');
							}
...
$(document).off('click',contentBK+" #booking-trans-resetvehicleinformationbtn:not('.disabled')").on('click',contentBK+" #booking-trans-resetvehicleinformationbtn:not('.disabled')",function(){
...
$(document).off('click',contentBK+" #booking-resetvehicleinformationmodal-savebtn:not('.disabled')").on('click',contentBK+" #booking-resetvehicleinformationmodal-savebtn:not('.disabled')",function(){
...
$(document).off('click',contentBK+' #booking-trans-viewstatushistorybtn:not(".disabled")').on('click',contentBK+' #booking-trans-viewstatushistorybtn:not(".disabled")',function(){
	$(contentBK+' #booking-statushistorymodal').modal('show');

	var bookingnumber = $(contentBK+' #pgtxnbooking-id').attr('pgtxnbooking-number');

	$(document).off('shown.bs.modal',contentBK+' #booking-statushistorymodal').on('shown.bs.modal',contentBK+' #booking-statushistorymodal',function(){
			$(document).off('shown.bs.modal',contentBK+' #booking-statushistorymodal');
			$(contentBK+" #booking-statushistorytbl").flexOptions({
...
$(document).off('click',contentBK+' #booking-updatebookingstatusmodal-savebtn:not(".disabled")').on('click',contentBK+' #booking-updatebookingstatusmodal-savebtn:not(".disabled")',function(){
	...
	if(status==''||status==null||status=='NULL'||status==undefined||status=='null'){
		...
		$.confirm({
				...
				confirm: function(){
					$('#loading-img').removeClass('hidden');
					$.post(server+'booking.php',{updateBookingStatus:'kkjO#@siaah3h0$09odfj$owenxezpo92po@k@',bookingid:bookingid,actualpickupdate:actualpickupdate,pickedupby:pickedupby,remarks:remarks,status:status,driver:driver,helper:helper,platenumber:platenumber},function(data){
						...
						if(data.trim()=='success'){
							...
							$(document).off('hidden.bs.modal',modal).on('hidden.bs.modal',modal,function(){
								...
								$(modal+' .booking-updatebookingstatusmodal-driver').empty().trigger('change');
								$(modal+' .booking-updatebookingstatusmodal-helper').empty().trigger('change');
								$(modal+' .booking-updatebookingstatusmodal-platenumber').empty().trigger('change');

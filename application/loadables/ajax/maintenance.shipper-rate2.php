<?php
	...
	while ($obj = mysql_fetch_object($results)) {
		...
		$shippername = utfEncode($obj->shippername);
		...
		$viewshipperratefreightchargebtn = (userAccess(USERID,'.editshipperratebtn')==false&&$fixedrateflag=='NO')?"<img src='../resources/img/weight_add.png' rowid='$id' title='Freight Rate based on Weight Range' class='viewshipperratefreightchargebtn pointer' height='20px'>":'';
		...
		if(trim($viewshipperratefreightchargebtn)!=''){
			array_push($arr, $viewshipperratefreightchargebtn);
		}

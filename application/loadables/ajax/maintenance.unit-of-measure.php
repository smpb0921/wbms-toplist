<?php
	...
	$customqry =   "select unit_of_measure.id,
					...
					left join user as cuser on cuser.id=unit_of_measure.created_by
					left join user as uuser on uuser.id=unit_of_measure.updated_by";
	...
	while ($obj = mysql_fetch_object($results)) {
		...
		$editbtn = (userAccess(USERID,'.editunitofmeasurebtn')==false)?"<img src='../resources/flexigrid/images/edit.png' rowid='$id' code='$code' desc='$desc' title='Edit UOM' class='editunitofmeasurebtn pointer' data-toggle='modal' href='#editunitofmeasuremodal' height='20px'>":'';

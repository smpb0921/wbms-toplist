					...
					<div class='col-md-12 no-padding margin-bottom-sm topbuttonsdiv'>
						<div class='padded-with-border-engraved topbuttonswrapper'>
							<div class='button-group'>
								<div class='button-group-btn active' title='New' id='billingstatement-trans-newbtn'
									href='#addbillingstatementmodal' data-toggle='modal'>
					...
					<div class='billingstatement-inputfields'>
						...
						<div class='col-lg-2'>
							...
							<div class='button-group-btn fluid searchbtn active' data-toggle='modal'
								href='#billingstatement-searchmodallookup'>
						...
						<div class="col-lg-10">
							...
							<div class='col-md-12 no-padding margin-bottom-xs margin-top-sm'>
								<div class="panel-group classictheme margin-bottom-xs"
									id="billingstatement-panelheader-wrapper" role="tablist"
									aria-multiselectable="true">

									<div class="panel panel-default">
										<div class="panel-heading" role="tab" data-toggle="collapse"
											href="#billingstatement-panelheader">
											Header
										</div>
										<div id="billingstatement-panelheader" class="panel-collapse collapse in"
											role="tabpanel">
											<div class="panel-body">
												<div class='row'>
													<div class="col-md-12">
												...
												<div class="form-horizontal">
													<div class="col-md-7">
														...
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='hidden'
																	class='billingstatement-shipmenttypeid'>
																<input type='text'
																	class='form-input form-control billingstatement-shipmenttype alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-input form-control billingstatement-billingtype alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															<label class='control-label col-md-3'>Billed To</label>
															<div class='col-md-9'>
																<input type='text'
																	class='form-input form-control billingstatement-billedto alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class='col-md-5'>
																...
																<input type='hidden' class='billingstatement-agentid'>
																<input type='hidden'
																	class='billingstatement-consigneeid'>
																<input type='text'
																	class='form-input form-control billingstatement-accountnumber alwaysdisabled'
																	disabled="true">
														...
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-input form-control billingstatement-accountname alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-input form-control billingstatement-companyname alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-input form-control billingstatement-accountexecutive alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<!--<br>
														...
														<div class="form-group">
															...
															<div class="col-lg-9">
																<input type='text'
																	class='form-control billingstatement-contact'>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-lg-4">
																<input type='text'
																	class='form-control billingstatement-phone'>
															</div>

															<label class='control-label col-lg-1'>Mobile</label>
															<div class="col-lg-4">
																<input type='text'
																	class='form-control billingstatement-mobile'>
															</div>
														</div>
														<!--<div class="form-group">
														...
														<div class="form-group">
															...
															<div class="col-lg-9">
																<input type='text'
																	class='form-control billingstatement-email'>
															</div>
														</div>
														<br>
														<div class="form-group">
															<label
																class='control-label col-md-3'>Region/Province</label>
															<div class='col-md-9'>
																<input type='text'
																	class='form-control billingstatement-billingprovince'>
														...
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-control billingstatement-billingcity'>
														...
														<div class="form-group">
															<label
																class='control-label col-md-3'>District/Barangay</label>
															<div class='col-md-9'>
																<input type='text'
																	class='form-control billingstatement-billingdistrict'>
														...
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-control billingstatement-billingzipcode'>
														...
														<div class="form-group">
															...
															<div class='col-md-9'>
																<textarea
																	class='form-input form-control billingstatement-billingstreet'
																	rows='3'></textarea>
														...
														<div class="form-group">
															...
															<div class='col-md-9'>
																<input type='text'
																	class='form-control billingstatement-billingcountry'>
															</div>
														</div>
														<div class="form-group">
															<label class='control-label col-md-3'>Remarks</label>
															<div class="col-md-9">
																<textarea class='form-control billingstatement-remarks'
																	rows='4'></textarea>
															</div>
														</div>
														<!--</fieldset>-->
													...
													<div class='col-md-5'>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-documentdate'>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-attention'>
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-invoice'>
															</div>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															<label class='control-label col-md-3'>Payment Due
																Date</label>
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-paymentduedate'>
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-createddate alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-createdby alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-updateddate alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-updatedby alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-posteddate alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-postedby alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-receiveddate alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type='text'
																	class='form-control billingstatement-receivedby alwaysdisabled'
																	disabled="true">
															</div>
														</div>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<textarea class='form-control billingstatement-reason'
																	rows='4'></textarea>
															</div>
														</div>
								...
								<div class="panel-group classictheme margin-bottom-xs"
									id="billingstatement-paneldetails-wrapper" role="tablist"
									aria-multiselectable="true">

									<div class="panel panel-default">
										<div class="panel-heading" role="tab" data-toggle="collapse"
											href="#billingstatement-paneldetails">
											Details
										</div>
										<div id="billingstatement-paneldetails" class="panel-collapse collapse in"
											role="tabpanel">
											<div class="panel-body">
												<div class='row'>
													<div class="col-md-12">
												...
												<div class='form-horizontal'>
													<div class='col-md-offset-9 col-md-3'>
														<div class="form-group">
															...
															<input type='text'
																class='text-right form-control billingstatement-totalvatablecharges'
													...
													<div class='col-md-offset-9 col-md-3'>
														<div class="form-group">
															<label class='control-label'>Total Non Vatable
																Charges</label>
															<input type='text'
																class='text-right form-control billingstatement-totalnonvatablecharges'
																style='height: 30px; font-size: 20px'>
													...
													<div class='col-md-offset-9 col-md-3'>
														<div class="form-group">
															...
															<input type='text'
																class='text-right form-control billingstatement-vat'
																style='height: 30px; font-size: 20px'>
													...
													<div class='col-md-offset-9 col-md-3'>
														<div class="form-group">
															...
															<input type='text'
																class='text-right form-control billingstatement-totalbillingamount'
																style='height: 30px; font-size: 20px'>
													...
													<div class='col-md-offset-9 col-md-3'>
														<div class="form-group">
															...
															<input type='text'
																class='text-right form-control billingstatement-cancelledamount'
																style='height: 30px; font-size: 20px'>
													...
													<div class='col-md-offset-9 col-md-3'>
														<div class="form-group">
															...
															<input type='text'
																class='text-right form-control billingstatement-revisedamount'
																style='height: 30px; font-size: 20px'>
...
<div class="modal fade" id="addbillingstatementmodal">
		...
		<div class="modal-content">
				...
				<div class='col-md-12'>
					<div class='form-horizontal'>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type='text' class='form-control billingstatementmodal-documentdate datepicker'>
							</div>

							<label class='control-label col-lg-2'>Payment Due Date*</label>
							<div class="col-lg-4">
								<input type='text' class='form-control billingstatementmodal-paymentduedate datepicker'>
							</div>
						</div>
						<div class="form-group">
							<label class='control-label col-lg-2'>Attention*</label>
							<div class="col-lg-4">
								<input type='text' class='form-control billingstatementmodal-attention blsattention'>
							</div>
							<label class='control-label col-lg-2'>VAT Flag</label>
							<div class="col-lg-4">
								<select class="form-control billingstatementmodal-vatflag blsvatflag">
									<option value="1">Yes</option>
									<option value="0">No</option>
								</select>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type='text' class='form-control billingstatementmodal-invoice blsinvoice'>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<select
									class='form-control form-input billingstatementmodal-shipmenttype blsshipmenttypeselection shipmenttypedropdownselect'
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<select
									class='form-control form-input billingstatementmodal-billingtype billingtypedropdownselect'
									style='width:100%'></select>
							</div>
						</div>

						<div class="form-group">
							<label class='control-label col-lg-2'>Billed To*</label>
							<div class="col-lg-10">
								<select
									class='form-control form-input billingstatementmodal-billedto blsbilledtoselection select2'
									style='width:100%'>
									<option value="">-</option>
						...
						<div class="form-group hidden consigneewrapper">
							<label class='control-label col-lg-2'>Consignee*</label>
							<div class="col-lg-10">
								<select data-type='consignee'
									class='form-control form-input billingstatementmodal-consignee blsaccountselection consigneedropdownselect'
									style='width:100%'></select>
							</div>
						</div>

						<div class="form-group hidden agentwrapper">
							<label class='control-label col-lg-2'>Agent*</label>
							<div class="col-lg-10">
								<select data-type='agent'
									class='form-control form-input billingstatementmodal-agent blsaccountselection agentdropdownselect'
									style='width:100%'></select>
							</div>
						</div>
						...
						<div class="form-group hidden shipperwrapper">
							<label class='control-label col-lg-2'>Shipper*</label>
							<div class="col-lg-10">
								<select data-type='shipper'
									class='form-control form-input billingstatementmodal-shipper blsaccountselection blsshipperselection shipperdropdownselect'
									style='width:100%'></select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<select
									class='form-control form-input billingstatementmodal-accountexecutive accountexecutivedropdownselect'
									style='width:100%'></select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<textarea class='form-control billingstatementmodal-remarks' rows='4'></textarea>
							</div>
						</div>
						<fieldset>
			...
			<div class='modal-footer'>
				<div class="text-center">
					<button class='btn btn-blue2 mybtn' id='addbillingstatementmodal-savebtn'>Save</button>
				...
				<div class='col-md-12'>
					<div class='form-horizontal'>
						...
						<div class="form-group">
							<label class='control-label col-lg-2'>Attention*</label>
							<div class="col-lg-4">
								<input type='text' class='form-control billingstatementmodal-attention'>
							</div>

							<label class='control-label col-lg-2'>Billing Statement No.*</label>
							<div class="col-lg-4">
								<input type='text' class='form-control billingstatementmodal-invoice'>
							</div>
						</div>
						<div class="form-group">
							<label class='control-label col-lg-2'>VAT Flag</label>
							<div class="col-lg-4">
								<select class="form-control billingstatementmodal-vatflag">
									<option value="1">Yes</option>
									<option value="0">No</option>
								</select>
							</div>
						...
						<div class="form-group hidden shipperwrapper">
							...
							<div class="col-lg-10">
								<select data-type='shipper'
									class='form-control form-input billingstatementmodal-shipper blsaccountselection shipperdropdownselect'
									style='width:100%'></select>
							</div>
						</div>
						...
						<div class="form-group hidden">
							<label class='control-label col-lg-2'>Shipper</label>
							<div class="col-lg-10">
								<input type='text' class='form-control billingstatementmodal-shipperstr alwaysdisabled'
									disabled>
							</div>
						</div>
						<!--<div class="form-group">
            					<label class='control-label col-lg-2'>Shipper*</label>
            					<div class="col-lg-10">
            						<select class='form-control form-input billingstatementmodal-shipper blsshipperselection shipperdropdownselect' style='width:100%'></select>
            					</div>
            				</div>-->
						...
						<fieldset>
							...
							<div class="form-group">
								<label class='control-label col-lg-2'>Contact Name</label>
								<div class="col-lg-10">
									<input type='text' class='form-control billingstatementmodal-contact blscontact'>
								</div>
							</div>
							<div class="form-group">
								<label class='control-label col-lg-2'>Phone</label>
								<div class="col-lg-10">
									<input type='text' class='form-control billingstatementmodal-phone blsphone'>
								</div>
							</div>
							<div class="form-group">
								<label class='control-label col-lg-2'>Mobile</label>
								<div class="col-lg-10">
									<input type='text' class='form-control billingstatementmodal-mobile blsmobile'>
								</div>
							</div>
							<div class="form-group">
								<label class='control-label col-lg-2'>Email</label>
								<div class="col-lg-10">
									<input type='text' class='form-control billingstatementmodal-email blsemail'>
								</div>
							</div>
						</fieldset>
						...
						<fieldset>
							...
							<div class='addressgroupwrapper'>
								<div class="form-group">
									...
									<div class='col-md-10'>
										<select
											class='form-control billingstatementmodal-province addrdropregion addressregiondropdownselect'></select>
								...
								<div class="form-group">
									...
									<div class='col-md-10'>
										<select
											class='form-control billingstatementmodal-city addrdropcity addresscitydropdownselect'></select>
								...
								<div class="form-group">
									...
									<div class='col-md-10'>
										<select
											class='form-control billingstatementmodal-district addrdropdistrict addressdistrictdropdownselect'></select>
								...
								<div class="form-group">
									...
									<div class='col-md-10'>
										<select
											class='form-control billingstatementmodal-zipcode addrdropzip addresszipcodedropdownselect'></select>
								...
								<div class="form-group">
									...
									<div class='col-md-10'>
										<textarea class='form-input form-control billingstatementmodal-street'
											rows='3'></textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class='col-md-10'>
										<select
											class='form-control countriesdropdownselect billingstatementmodal-country'></select>
									</div>
								</div>
							</div>
						</fieldset>
				...
				<div class='col-md-9'>
					<div class='form-horizontal'>
						...
						<div class="form-group">
							...
							<div class='col-md-9'>
								<input type='text'
									class='form-input form-control voidbillingstatementtransactionmodal-txnnumber'
									disabled="true">
							</div>
						</div>
						<div class="form-group">
							<label class='control-label col-md-3'>Remarks</label>
							<div class='col-md-9'>
								<textarea class='form-control voidbillingstatementtransactionmodal-remarks'
									rows='6'></textarea>
							</div>
						</div>
					</div>
...
<div class="modal fade" id="unpostbillingstatementtransactionmodal">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
				...
				<div class='col-md-9'>
					<div class='form-horizontal'>
						...
						<div class="form-group">
							...
							<div class='col-md-9'>
								<input type='text'
									class='form-input form-control unpostbillingstatementtransactionmodal-txnnumber'
									disabled="true">
							</div>
						</div>
						<div class="form-group">
							<label class='control-label col-md-3'>Remarks</label>
							<div class='col-md-9'>
								<textarea class='form-control unpostbillingstatementtransactionmodal-remarks'
									rows='6'></textarea>
							</div>
						</div>
					</div>
			...
			<div class='modal-footer'>
				<div class="text-center">
					<button class='btn btn-blue2 mybtn'
						id='unpostbillingstatementtransactionmodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
				...
				<div class="form-horizontal">
					<div class='col-md-6'>
						<div class="form-group">
							...
							<div class="col-md-9">
								<select
									class='form-control form-input billingstatementsearch-status billingstatementstatusdropdownselect'>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<select
									class='form-control form-input billingstatementsearch-shipper shipperdropdownselect'>
					...
					<div class='col-md-6'>
						<div class="form-group">
							...
							<div class="col-md-8">
								<select class='form-control form-input billingstatementsearch-paidflag select2'
									style='width:100%'>
									<option value=''></option>
									<option value='0'>NO</option>
									<option value='1'>YES</option>
				...
				<div class='col-md-12'>
					<div class='form-horizontal'>
						...
						<div class="form-group">
							...
							<input type='text' class='form-input form-control togglepaidflagmodal-txnnumber'
								disabled="true">
...
<div class="modal fade" id="blsuploadwaybillmodal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" action='../scripts/billing-statement-waybill-upload.php' method='post'
					id='blsuploadwaybillmodal-form' enctype='multipart/form-data'
					target='billingstatementuploadtransactionlogframe'>
					<input type='hidden' class='blswaybilluploadbillingnumber' name='blswaybilluploadbillingnumber'>
					<div class='col-md-4'>
						Please make sure to follow the right format. Waybill Transactions with missing/incorrect details
						will not be uploaded in the system.
						Click <a class='pointer' id='billing-statement-downloadtransactionfiletemplatebtn'
							href='../file-templates/billing-transaction-waybill-upload-template.xlsx'>here</a> to
						download file template.
					</div>
					<div class='col-md-offset-1 col-md-6'>
						<div class="form-group">
							<label class='control-label'>Billing Number</label>
							<input type='text' class='form-control blsuploadwaybillmodal-billingnumber'
								name='blsuploadwaybillmodal-billingnumber' disabled>
						</div>
						<div class="form-group">
							<label class='control-label'>Select an Excel File</label>
							<input type='file' class='form-control blsuploadwaybillmodal-file'
								name='blsuploadwaybillfile'>
						</div>
					</div>
				</form>
				<br>
...
<div class="modal fade" id="blsuploadwaybilllogmodal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<iframe id="billingstatementuploadtransactionlogframe" name="billingstatementuploadtransactionlogframe"
					height="600" width="100%" frameborder="0" scrolling="yes" style='background: #fff'></iframe>
			</div>
		</div>
	</div>
</div>
...
$(document).ready(function() {
	...
	$(inputfieldsBLS + ' input,' + inputfieldsBLS + ' textarea,' + inputfieldsBLS + ' select').attr('disabled',
		'disabled');
	...
	$(tabBLS + " .agentdropdownselect").select2({
		ajax: {
	...
	$(tabBLS + " .consigneedropdownselect").select2({
		ajax: {
	...
	function blsDeleteWaybillNumber() {
		...
		if (wbnumbersid.length > 0) {
			$.post(server + 'billing-statement.php', {
	...
	$(tabBLS + ' #billingstatement-detailstbl').flexigrid({
		...
		colModel: [{
			...
			{
				display: 'BOL No.',
				name: 'txn_billing_waybill.waybill_number',
				width: 130,
				sortable: true,
				align: 'left'
			},
			...
			},
			{
				...
				name: 'txn_waybill.document_date',
				width: 150,
				sortable: true,
				align: 'left'
			},
			...
			{
				display: 'Chargeable Weight',
				name: 'txn_billing_waybill.chargeable_weight',
				width: 180,
				sortable: true,
				align: 'right'
			},
			{
				display: 'Total Vatable Charges',
				name: 'txn_billing_waybill.vatable_charges',
				width: 180,
				sortable: true,
				align: 'right'
			},
			{
				display: 'Non-Vatable Charges',
				name: 'txn_billing_waybill.other_charges_non_vatable',
				width: 180,
				sortable: true,
				align: 'right'
			},
			...
			{
				display: 'Amount',
				name: 'txn_billing_waybill.amount',
				width: 180,
				sortable: true,
				align: 'right'
			}
		...
		buttons: [{
			...
			{
				name: 'Scan',
				bclass: 'qrcode blsscanwaybillbtn hidden',
				onpress: blsScanWaybillNumber
			},

			{
				name: 'Add',
				bclass: 'add blswaybilllookupbtn hidden',
				onpress: blsSearchForWaybill
			},
			{
				name: 'Delete',
				bclass: 'delete blsdeletewaybillbtn hidden',
				onpress: blsDeleteWaybillNumber
			},
			{
				name: 'Upload',
				bclass: 'upload blsuploadwaybillbtn hidden',
				onpress: ''
			}
	...
	$(tabBLS + ' #blssearchwaybilltransactiontbl').flexigrid({
		...
		colModel: [{
			...
			{
				display: 'BOL No.',
				name: 'txn_waybill.waybill_number',
				width: 150,
				sortable: true,
				align: 'left'
			},
			...
			},
			{
				...
				name: 'txn_waybill.delivery_date',
				width: 130,
				sortable: true,
				align: 'left'
			},
			...
			{
				display: 'Consignee',
				name: 'txn_waybill.consignee_account_name',
				width: 200,
				sortable: true,
				align: 'left'
			},
		...
		buttons: [{
				name: 'Add',
				bclass: 'add blswaybilllookup-addbtn'
			},
			{
				separator: true
			},
			{
				name: 'Select All',
				bclass: 'select1 blswaybilllookup-selectallbtn',
				onpress: blsSelectAllWaybillNumber
			},
			{
				separator: true
			},
			{
				name: 'Deselect All',
				bclass: 'deselect1 blswaybilllookup-deselectallbtn',
				onpress: blsDeselectAllWaybillNumber
			}
		],
		searchitems: [
	...
	$(tabBLS + " #billingstatementsearch-table").flexigrid({
		...
		colModel: [{
				display: 'Billing No.',
				name: 'txn_billing.billing_number',
				width: 120,
				sortable: true,
				align: 'left'
			},
			...
			{
				display: 'Document Date',
				name: 'txn_billing.document_date',
				width: 100,
				sortable: true,
				align: 'left'
			},

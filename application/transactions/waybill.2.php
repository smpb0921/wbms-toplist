									                                                        	...
									                                                        	<fieldset>
										                                                        	<legend>Consignee Information</legend>
										                                                        		...
										                                                        		<div class="form-group hidden">
																											<label class='control-label col-md-3'>Tracking Number</label>
																											<div class='col-md-9'>
								                                                                ...
								                                                                <div class="form-group">
									                                                                ...
									                                                                <div class="col-lg-7">
										                                                                <div class='input-group'>
										                                                                    ...
										                                                                    <span class="input-group-addon inputgroupbtn" style='line-height: 0px'>
										                                                                    	&nbsp;&nbsp;
									                                                            				<input type='checkbox' class='waybill-zeroratedcheckbox' > <span class='input-group-addon-label' style='font-size: 12px; font-weight: 600'>&nbsp;Zero Rated</span>
									                                                            			</span>
									                                                            		</div>
									                                                                </div>
									                                                            </div>
            ...
            <div class="modal-body">
	            	<div class="form-horizontal">
	            		<div class='col-md-6'>
			            	...
			            	<div class="form-group">
			            			<label class='control-label col-md-3'>Mother BOL</label>
			            			<div class="col-md-9">
            ...
            <div class="modal-body">
           	...
           	<div class='modal-footer'>
           		<div class="text-center">
					...
					<button class='btn btn-blue2 mybtn' id='waybillprintingmodal-savebtn'>Print</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
           	</div>
        </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    	...
	    	$(tabWB+" #waybillsearch-table").flexigrid({
				...
				dataType: 'json',
				colModel : [
						{display: 'BOL/Tracking No.', name : 'waybill_number', width : 150, sortable : true, align: 'left'},
						{display: 'MAWBL', name : 'mawbl_bl', width : 100, sortable : true, align: 'left'},
						{display: 'Status', name : 'status', width : 100, sortable : true, align: 'left'},
						{display: 'Booking No.', name : 'booking_number', width : 100, sortable : true, align: 'left', hide:true},
						...
						{display: 'Destination Route', name : 'destinationroute', width : 200, sortable : true, align: 'left', hide:true},
						{display: 'Shipper', name : 'shipper', width : 200, sortable : true, align: 'left'},
						{display: 'Consignee', name : 'consignee', width : 200, sortable : true, align: 'left'},
						...
						{display: 'Chargeable Weight', name : 'package_chargeable_weight', width : 100, sortable : true, align: 'right'},
						{display: 'Actual Weight', name : 'package_actual_weight', width : 100, sortable : true, align: 'right'},
						{display: 'Manifest No.', name : 'manifest_number', width : 100, sortable : true, align: 'left'},
						{display: 'Invoice No.', name : 'invoice_number', width : 100, sortable : true, align: 'left'},
			...
			$(tabWB+" #waybill-statushistorytbl").flexigrid({
				...
				colModel : [
						...
						{display: 'Received Date', name : 'received_date', width : 150, sortable : true, align: 'left'},

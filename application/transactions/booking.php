							                                                    ...
							                                                    <div class='col-lg-6'>
							                                                        ...
							                                                        <fieldset>
							                                                        	...
							                                                        	<div class='form-horizontal'>
																							...
																							<div class="form-group">
																								<label class='control-label col-lg-3'>Trucking Details</label>
																								<div class="col-lg-9">
																									<textarea class='form-input form-control booking-truckingdetails' rows='4'></textarea>
																								</div>
																							</div>
																						</div>
	            	...
	            	<div class="form-horizontal">
	            		<div class='col-md-6'>
	            			<div class="form-group">
			            			...
			            			<div class="col-md-9">
			            				 <select class='form-control form-input bookingsearch-bookingtype bookingtypedropdownselect' style='width:100%'></select>
			            			</div>
		            		</div>
	            			<div class="form-group">
...
<div class="modal fade" id="viewbookingattachments">
            	...
            	<div class='col-md-12'>
					<div id="drop-area" class='drop-area'>
						<div>
							...
							<input type='hidden' id='viewbookingattachments-bookingNumber'/>
						</div>
					</div>
	            	<table id='viewbookingattachments-table'>
						<tbody></tbody>
					</table>
				</div>
           	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
			...
			$("#drop-area").dmUploader({
  				url: '../scripts/upload-booking-attachments.php',
  				onInit: function(){
  				},
				extraData: function() {
					return {
						"bookingNumber": $('#viewbookingattachments-bookingNumber').val()
					};
				},
				onComplete:function(){
					$(tabBK + ' #viewbookingattachments-table').flexReload();
				}
			});
	    	...
	    	$(tabBK+" .bookingtypedropdownselect").select2({
	            ajax: {
	    	...
	    	$(tabBK+" #bookingsearch-table").flexigrid({
				...
				colModel : [
						...
						{display: 'Booking No.', name : 'txn_booking.booking_number', width : 100, sortable : true, align: 'left'},
						{display: 'Booking Type', name : 'booking_type.description', width : 100, sortable : true, align: 'left'},
						{display: 'Status', name : 'txn_booking.status', width : 100, sortable : true, align: 'left'},
						...
						{display: 'Driver', name : 'txn_booking.driver', width : 200, sortable : true, align: 'left'},
						{display: 'Pickup Date', name : 'txn_booking.pickup_date', width : 100, sortable : true, align: 'left'},
						{display: 'Pickup City', name : 'txn_booking.shipper_pickup_city', width : 130, sortable : true, align: 'left'},
						{display: 'Pickup Region', name : 'txn_booking.shipper_pickup_state_province', width : 130, sortable : true, align: 'left'},
						{display: 'Created by', name : 'txn_booking.created_by', width : 150, sortable : true, align: 'left'},
						{display: 'Created Date', name : 'txn_booking.created_date', width : 150, sortable : true, align: 'left'},
						{display: 'System ID', name : 'txn_booking.id', width : 80, sortable : true, align: 'left'}
				],
				
				searchitems : [
						{display: 'Booking Number', name : 'txn_booking.booking_number', isdefault: true},
						{display: 'Booking Type', name : 'booking_type.description'},
						...
						{display: 'Driver', name : 'txn_booking.driver'}
				],
			...
			$(tabBK+" #viewbookingattachments-table").flexigrid({
				url: 'loadables/ajax/transactions.booking-attachments.php',
				dataType: 'json',
				colModel : [
						{display: 'Actions', name : 'action', width : 80, sortable : false, align: 'center'},
						{display: 'File Name', name : 'txn_booking_attachments.file_name', width : 300, sortable : true, align: 'left'},
						{display: 'Created Date', name : 'txn_booking_attachments.created_date', width : 200, sortable : true, align: 'left'},
						{display: 'Created By', name : 'createdby', width : 350, sortable : true, align: 'left'}
				],
				
				searchitems : [
						{display: 'Filename', name : 'txn_booking_attachments.file_name', isdefault: true}
				],
				sortname: "txn_booking_attachments.file_name",
				sortorder: "asc",
				usepager: true,
				title: "Attachments",
				useRp: true,

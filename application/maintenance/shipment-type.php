...
<div class="modal fade" id="addshipmenttypemodal">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn shipmenttypemodal-savebtn' id='addshipmenttypemodal-savebtn'>Save</button>
...
<div class="modal fade" id="editshipmenttypemodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='shipmenttypemodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn shipmenttypemodal-savebtn' id='editshipmenttypemodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#shipmenttypetable").flexigrid({
				url: 'loadables/ajax/maintenance.shipment-type.php',
				dataType: 'json',
				colModel : [
				...
				buttons : [
						{name: 'Add', bclass: 'add addshipmenttypebtn', onpress : addshipmenttype},
						{separator: true},
						{name: 'Delete', bclass: 'delete deleteshipmenttypebtn', onpress : deleteshipmenttype}
				],
				searchitems : [
		...
		function addshipmenttype(){
				$('#addshipmenttypemodal').modal('show');
		}

		function deleteshipmenttype(){

		
			if(parseInt($('#shipmenttypetable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#shipmenttypetable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/shipment-type.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

								if(response.trim()=='success'){
									$('#shipmenttypetable').flexOptions({
											url:'loadables/ajax/maintenance.shipment-type.php',
											sortname: "description",
											sortorder: "asc"
									}).flexReload(); 

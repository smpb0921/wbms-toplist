		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn carriermodal-savebtn' id='addcarriermodal-savebtn'>Save</button>
...
<div class="modal fade" id="editcarriermodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='carriermodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn carriermodal-savebtn' id='editcarriermodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="uploadcarriermodal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action='../scripts/carrier-upload.php' method='post' id='uploadcarriermodal-form'  enctype='multipart/form-data' target='carrieruploadtransactionlogframe'>
                    <div class='col-md-4'>
                        Please make sure to follow the right format.
                        Click <a class='pointer' id='carrier-downloadtransactionfiletemplatebtn' href='../file-templates/carrier-template.xlsx'>here</a> to download file template.
                    </div>
                    <div class='col-md-offset-1 col-md-6'>
                        <div class="form-group">
                            <label class='control-label'>Select an Excel File</label>
                            <input type='file' class='form-control uploadcarriermodal-file' name='uploadcarriermodal-file'>
                        </div>
                    </div>
                </form>
                <br>
            ...
            <div class="modal-footer">
                <div class="text-center">
                    <button class='btn btn-blue2 mybtn' id='uploadcarriermodal-uploadbtn'>Upload</button>
                    <button class='btn btn-blue2 mybtn modal-cancelbtn' >Cancel</button>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="carrier-uploadtransactionlogmodal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe id="carrieruploadtransactionlogframe" name="carrieruploadtransactionlogframe" height="600" width="100%" frameborder="0" scrolling="yes" style='background: #fff'></iframe>
            </div>
        </div>
    </div>
</div>
	...
	$(document).ready(function(){
		...
		$("#carriertable").flexigrid({
				...
				buttons : [
						...
						{separator: true},
						{name: 'Upload', bclass: 'upload uploadcarrierbtn', onpress : uploadCarrier}
				],
				searchitems : [
		...
		function uploadCarrier(){
			$('#uploadcarriermodal').modal('show');
		}
		...
		function deleteCarrier(){
			...
			if(parseInt($('#carriertable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#carriertable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/carrier.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

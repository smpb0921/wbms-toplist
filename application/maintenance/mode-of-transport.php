...
<div class="modal fade" id="addmodeoftransportmodal">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<div class="form-group">
								<label class='control-label'>Vol. Wgt Divisor*</label>
								<input type='number' class='form-input form-control volwgtdivisor'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn modeoftransportmodal-savebtn' id='addmodeoftransportmodal-savebtn'>Save</button>
...
<div class="modal fade" id="editmodeoftransportmodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='modeoftransportid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn modeoftransportmodal-savebtn' id='editmodeoftransportmodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#modeoftransporttable").flexigrid({
				...
				colModel : [
						...
						{display: 'Vol Wgt Divisor', name : 'divisor', width : 100, sortable : true, align: 'right'},
				...
				buttons : [
						{name: 'Add', bclass: 'add addmodeoftransportbtn', onpress : addModeOfTransport},
						{separator: true},
						{name: 'Delete', bclass: 'delete deletemodeoftransportbtn', onpress : deleteModeOfTransport}
				],
				searchitems : [
		...
		function addModeOfTransport(){
				$('#addmodeoftransportmodal').modal('show');
		}

		function deleteModeOfTransport(){

		
			if(parseInt($('#modeoftransporttable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#modeoftransporttable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/mode-of-transport.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

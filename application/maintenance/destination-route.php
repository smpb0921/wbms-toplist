...
<div class="container-fluid">
    <div class="pageContent noborder">
    	...
    	<table id='destinationroutetable'>
			<tbody></tbody>
...
<div class="modal fade" id="adddestinationroutemodal">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn destinationroutemodal-savebtn' id='adddestinationroutemodal-savebtn'>Save</button>
...
<div class="modal fade" id="editdestinationroutemodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='destinationroutemodalid'>
							<div class="form-group">
								<label class='control-label'>Code</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn destinationroutemodal-savebtn' id='editdestinationroutemodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#destinationroutetable").flexigrid({
				url: 'loadables/ajax/maintenance.destination-route.php',
				dataType: 'json',
				colModel : [
				...
				buttons : [
						{name: 'Add', bclass: 'add adddestinationroutebtn', onpress : addDestinationRoute},
						{separator: true},
						{name: 'Delete', bclass: 'delete deletedestinationroutebtn', onpress : deleteDestinationRoute}
				],
				searchitems : [
		...
		function addDestinationRoute(){
				$('#adddestinationroutemodal').modal('show');
		}

		function deleteDestinationRoute(){

		
			if(parseInt($('#destinationroutetable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#destinationroutetable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/destination-route.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

								if(response.trim()=='success'){
									$('#destinationroutetable').flexOptions({
											url:'loadables/ajax/maintenance.destination-route.php',
											sortname: "description",
											sortorder: "asc"
									}).flexReload(); 

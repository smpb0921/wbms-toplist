		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn servicesmodal-savebtn' id='addservicesmodal-savebtn'>Save</button>
...
<div class="modal fade" id="editservicesmodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='servicesmodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn servicesmodal-savebtn' id='editservicesmodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#servicestable").flexigrid({
				...
				buttons : [
						{name: 'Add', bclass: 'add addservicesbtn', onpress : addServices},
						{separator: true},
						{name: 'Delete', bclass: 'delete deleteservicesbtn', onpress : deleteServices}
				],
				searchitems : [

...
<div class="modal fade" id="addunitofmeasuremodal">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn unitofmeasuremodal-savebtn' id='addunitofmeasuremodal-savebtn'>Save</button>
...
<div class="modal fade" id="editunitofmeasuremodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='unitofmeasuremodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn unitofmeasuremodal-savebtn' id='editunitofmeasuremodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#unitofmeasuretable").flexigrid({
				url: 'loadables/ajax/maintenance.unit-of-measure.php',
				dataType: 'json',
				colModel : [
				...
				buttons : [
						{name: 'Add', bclass: 'add', onpress : addunitofmeasure},
						{separator: true},
						{name: 'Delete', bclass: 'delete', onpress : deleteunitofmeasure}
				],
				searchitems : [
		...
		function addunitofmeasure(){
				$('#addunitofmeasuremodal').modal('show');
		}

		function deleteunitofmeasure(){

		
			if(parseInt($('#unitofmeasuretable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#unitofmeasuretable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/unit-of-measure.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

								if(response.trim()=='success'){
									$('#unitofmeasuretable').flexOptions({
											url:'loadables/ajax/maintenance.unit-of-measure.php',
											sortname: "description",
											sortorder: "asc"
									}).flexReload(); 

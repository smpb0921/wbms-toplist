...
<div class="container-fluid">
    <div class="pageContent noborder">
    	...
    	<table id='transportchargestable'>
			<tbody></tbody>
...
<div class="modal fade" id="addtransportchargesmodal">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn transportchargesmodal-savebtn' id='addtransportchargesmodal-savebtn'>Save</button>
...
<div class="modal fade" id="edittransportchargesmodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='transportchargesmodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn transportchargesmodal-savebtn' id='edittransportchargesmodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#transportchargestable").flexigrid({
				...
				buttons : [
						{name: 'Add', bclass: 'add addtransportchargesbtn', onpress : addTransportCharges},
						{separator: true},
						{name: 'Delete', bclass: 'delete deletetransportchargesbtn', onpress : deleteTransportCharges}
				],
				searchitems : [
		...
		function addTransportCharges(){
				$('#addtransportchargesmodal').modal('show');
		}

		function deleteTransportCharges(){

		
			if(parseInt($('#transportchargestable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#transportchargestable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/transport-charges.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

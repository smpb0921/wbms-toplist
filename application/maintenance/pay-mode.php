...
<div class="modal fade" id="addpaymodemodal">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn paymodemodal-savebtn' id='addpaymodemodal-savebtn'>Save</button>
...
<div class="modal fade" id="editpaymodemodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='paymodemodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn paymodemodal-savebtn' id='editpaymodemodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#paymodetable").flexigrid({
				...
				buttons : [
						{name: 'Add', bclass: 'add', onpress : addpaymode},
						{separator: true},
						{name: 'Delete', bclass: 'delete', onpress : deletepaymode}
				],
				searchitems : [
		...
		function addpaymode(){
				$('#addpaymodemodal').modal('show');
		}

		function deletepaymode(){

		
			if(parseInt($('#paymodetable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#paymodetable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/pay-mode.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

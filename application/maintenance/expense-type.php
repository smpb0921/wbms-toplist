		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn expensetypemodal-savebtn' id='addexpensetypemodal-savebtn'>Save</button>
...
<div class="modal fade" id="editexpensetypemodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='expensetypemodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn expensetypemodal-savebtn' id='editexpensetypemodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#expensetypetable").flexigrid({
				url: 'loadables/ajax/maintenance.expense-type.php',
				dataType: 'json',
				colModel : [
				...
				buttons : [
						{name: 'Add', bclass: 'add addexpensetypebtn', onpress : addexpensetype},
						{separator: true},
						{name: 'Delete', bclass: 'delete deleteexpensetypebtn', onpress : deleteexpensetype}
				],
				searchitems : [
		...
		function deleteexpensetype(){
			...
			if(parseInt($('#expensetypetable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#expensetypetable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/expense-type.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

								if(response.trim()=='success'){
									$('#expensetypetable').flexOptions({
											url:'loadables/ajax/maintenance.expense-type.php',
											sortname: "description",
											sortorder: "asc"
									}).flexReload(); 

...
<div class="modal fade" id="addpouchsizemodal">
		...
		<div class="modal-content">
					...
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<div class="form-group">
								...
								<input type='number' class='form-input form-control maxweight' value='0'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn pouchsizemodal-savebtn' id='addpouchsizemodal-savebtn'>Save</button>
...
<div class="modal fade" id="editpouchsizemodal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<div class='page-title'>
			...
			<div class="modal-body">
					<div class="col-md-12">
						<form class="form-horizontal">
							...
							<input type='hidden' class='pouchsizemodalid'>
							<div class="form-group">
								<label class='control-label'>Code*</label>
								<input type='text' class='form-input form-control code'>
							...
							<div class="form-group">
								<label class='control-label'>Max Weight*</label>
								<input type='number' class='form-input form-control maxweight'>
			...
			<div class="modal-footer">
				<div class="text-center">
					<button class='btn btn-blue2 mybtn pouchsizemodal-savebtn' id='editpouchsizemodal-savebtn'>Save</button>
					<button class='btn btn-blue2 mybtn modal-cancelbtn'>Cancel</button>
				</div>
			</div>
		</div>
	...
	$(document).ready(function(){
		...
		$("#pouchsizetable").flexigrid({
				...
				colModel : [
						...
						{display: 'Max Weight', name : 'max_weight', width : 100, sortable : true, align: 'right'},
				...
				buttons : [
						{name: 'Add', bclass: 'add addpouchsizebtn', onpress : addpouchsize},
						{separator: true},
						{name: 'Delete', bclass: 'delete deletepouchsizebtn', onpress : deletepouchsize}
				],
				searchitems : [
		...
		function addpouchsize(){
				$('#addpouchsizemodal').modal('show');
		}

		function deletepouchsize(){

		
			if(parseInt($('#pouchsizetable .trSelected').length)>0){
				$.confirm({
					animation: 'bottom', 
					closeAnimation: 'top',
					animationSpeed: 1000,
					...
					confirm: function(){
							var data = [];
							$('#pouchsizetable .trSelected').each(function(){
								data.push($(this).attr('rowid'));
							});
							$.post('../scripts/pouch-size.php',{deleteSelectedRows:'skj$oihdtpoa$I#@4noi4AIFNlskoRboIh4!j3sio$*yhs',data:data},function(response){

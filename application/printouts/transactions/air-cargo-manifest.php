...
if($rowcount==1){
			...
			$pdf->cell(270,5,'AIR CARGO MANIFEST',0,1,'C');
			...
			function printHeader($pdf,$headerlinespacing,$columnwidths){
                ...
                $pdf->Cell($columnwidths[11],$headerlinespacing,'SUPPLIER\'S','LTR',0,'C');
                ...
                $pdf->Cell($columnwidths[11],$headerlinespacing,'AIRWAYBILL #','BLR',0,'C');
